/**
 * Canonical Panergos skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$PANERGOS_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`panergos_cli/skin_engine.py`),
 ...
 *   • CLI     → `panergos_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
