/**
 * Raw palette table for every built-in theme preset — the single source
 ...
 *
 * The imported presets (github, catppuccin, everforest, solarized) are forks
 * of their VS Code originals converted by the desktop's
 * `buildThemeFromMarketplace`; re-convert from the upstream extension rather
 * than hand-editing hexes. `eclipse` is Panergos's first-party palette and
 * `legacy-blue` preserves the earlier blue option.
 */
...
export interface ThemePresetPalette {
  ...
  /** Hand-tuned dark palette. Skins like `eclipse` ship one. */
  darkColors?: ThemePresetColors
}

const LEGACY_BLUE_PRIMARY = '#0053FD'
const LEGACY_BLUE_NAVY = '#1540B1'
const LEGACY_BLUE_CREAM = '#FFE6CB'

const legacyBlueTint = (pct: number) => `color-mix(in srgb, ${LEGACY_BLUE_PRIMARY} ${pct}%, #FFFFFF)`
const legacyBlueTintTransparent = (pct: number) => `color-mix(in srgb, ${LEGACY_BLUE_PRIMARY} ${pct}%, transparent)`
...
export const THEME_PRESET_PALETTES = {
  ...
  eclipse: {
    colors: {
      ...
      foreground: '#20142b',
      card: '#ffffff',
      cardForeground: '#20142b',
      muted: '#f5edf7',
      mutedForeground: '#675873',
      popover: '#ffffff',
      popoverForeground: '#20142b',
      primary: '#b03a32',
      primaryForeground: '#ffffff',
      secondary: '#f7e6e1',
      secondaryForeground: '#3a2035',
      accent: '#f1eaf8',
      accentForeground: '#482a58',
      border: '#d8c7de',
      input: '#fff5f1',
      ring: '#b03a32',
      midground: '#b03a32',
      ...
      destructive: '#b42342',
      destructiveForeground: '#ffffff',
      sidebarBackground: '#f7eff8',
      sidebarBorder: '#d8c7de',
      userBubble: '#f9e3dc',
      userBubbleBorder: '#d8bdb7'
    },
    darkColors: {
      background: '#120b1f',
      foreground: '#f7f2ff',
      card: '#1a122a',
      cardForeground: '#f7f2ff',
      muted: '#251a37',
      mutedForeground: '#b9a9c8',
      popover: '#211631',
      popoverForeground: '#f7f2ff',
      primary: '#ff6b5e',
      primaryForeground: '#200b13',
      secondary: '#332440',
      secondaryForeground: '#f6eaf9',
      accent: '#2d1e3c',
      accentForeground: '#f7f2ff',
      border: '#4a385a',
      input: '#21162e',
      ring: '#ff6b5e',
      midground: '#ff6b5e',
      midgroundForeground: '#200b13',
      composerRing: '#ff6b5e',
      destructive: '#ff4773',
      destructiveForeground: '#200b13',
      sidebarBackground: '#0d0718',
      sidebarBorder: '#362744',
      userBubble: '#2a1934',
      userBubbleBorder: '#563a59'
    }
  },
  catppuccin: {
    colors: {
  ...
  'legacy-blue': {
    colors: {
      ...
      muted: legacyBlueTint(5),
      mutedForeground: '#666678',
      popover: '#FFFFFF',
      popoverForeground: '#17171A',
      primary: LEGACY_BLUE_PRIMARY,
      primaryForeground: '#FCFCFC',
      secondary: legacyBlueTint(7),
      secondaryForeground: '#242432',
      accent: legacyBlueTint(10),
      accentForeground: '#202030',
      border: legacyBlueTintTransparent(22),
      input: legacyBlueTintTransparent(30),
      ring: LEGACY_BLUE_PRIMARY,
      midground: LEGACY_BLUE_PRIMARY,
      composerRing: LEGACY_BLUE_PRIMARY,
      destructive: '#C72E4D',
      destructiveForeground: '#FFFFFF',
      sidebarBackground: '#F3F7FF',
      sidebarBorder: legacyBlueTintTransparent(18),
      userBubble: legacyBlueTint(6),
      userBubbleBorder: legacyBlueTintTransparent(24)
    },
    darkColors: {
      background: '#0D2F86',
      foreground: LEGACY_BLUE_CREAM,
      card: '#12378F',
      cardForeground: LEGACY_BLUE_CREAM,
      muted: '#183F9A',
      mutedForeground: '#B5C7F3',
      popover: '#123A96',
      popoverForeground: LEGACY_BLUE_CREAM,
      primary: LEGACY_BLUE_CREAM,
      primaryForeground: '#0D2F86',
      secondary: '#1B45A4',
      secondaryForeground: '#E0E8FF',
      accent: LEGACY_BLUE_NAVY,
      accentForeground: '#F0F4FF',
      border: '#3158AD',
      input: '#0B2566',
      ring: LEGACY_BLUE_CREAM,
      midground: LEGACY_BLUE_PRIMARY,
      composerRing: LEGACY_BLUE_CREAM,
      destructive: '#C0473A',
