...
const emojibaseAssets = () => ({
  name: 'panergos:emojibase-assets',
...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\panergos\panergos-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@panergos/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@panergos/shared/color': path.resolve(__dirname, '../shared/src/color.ts'),
      '@panergos/shared': path.resolve(__dirname, '../shared/src'),
