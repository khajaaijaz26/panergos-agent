...
if (typeof (globalThis as any).localStorage === 'undefined') {
  class MemoryStorage implements Storage {
    ...
    getItem(k: string) {
      return this.store.get(String(k)) ?? null
    }
  ...
  for (const target of [globalThis, (globalThis as any).window].filter(Boolean)) {
    Object.defineProperties(target, {
      Storage: { value: MemoryStorage, configurable: true, writable: true },
      localStorage: { value: storage, configurable: true, writable: true },
    })
  }
}
