...
import { host, LruCache } from '@panergos/plugin-sdk'
...
// to (local, remote URL, SSH, or containers) must be able to find
...
// panergos_cli/config_defaults.py and tools/bot_relay.py and fails if the
