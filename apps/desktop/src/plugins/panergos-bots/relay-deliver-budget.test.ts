...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/panergos-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'panergos_cli/config_defaults.py'), 'utf8')
