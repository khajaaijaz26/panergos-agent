...
import { atom, host, useValue } from '@panergos/plugin-sdk'
...
export function previewKind(preview: null | string | undefined): { fromBot: null | string } {
  ...
  if (match) {
    ...
    // profile reads @panergos, never @default (#89484).
 ...
 *  (panergos-agent#90268). Older gateways omit worker_session — always false. */
