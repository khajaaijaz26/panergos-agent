...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@panergos/plugin-sdk'
 ...
 *  (panergos-agent#90102) and are discarded. Without `canonical_session` (older
