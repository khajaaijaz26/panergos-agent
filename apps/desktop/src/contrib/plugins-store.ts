 ...
 * `<panergos home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'panergos.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'panergos.desktop.disabledPlugins.v1'
