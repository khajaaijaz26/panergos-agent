...
export interface PetInfo {
  ...
  // the Panergos "run" activity state uses the in-place running row).
 ...
 * PANERGOS_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'panergos.desktop.pet-roam.v1'
