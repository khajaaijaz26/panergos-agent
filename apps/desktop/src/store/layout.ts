...
const SIDEBAR_PINNED_STORAGE_KEY = 'panergos.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'panergos.desktop.agentsGroupedByWorkspace'
const SIDEBAR_CRON_OPEN_STORAGE_KEY = 'panergos.desktop.sidebarCronOpen'
const SIDEBAR_MESSAGING_OPEN_STORAGE_KEY = 'panergos.desktop.sidebarMessagingOpen'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'panergos.desktop.sessionOrder'
const SIDEBAR_SESSION_ORDER_MANUAL_STORAGE_KEY = 'panergos.desktop.sessionOrder.manual'
const SIDEBAR_GROUPING_STORAGE_KEY = 'panergos.desktop.sidebarGrouping'
const SIDEBAR_ALL_PROFILES_GROUPING_STORAGE_KEY = 'panergos.desktop.sidebarGrouping.allProfiles'
const SIDEBAR_ALL_PROFILES_AGENTS_GROUPED_STORAGE_KEY = 'panergos.desktop.sidebarAgentsGrouped.allProfiles'
const SIDEBAR_SORT_KEY_STORAGE_KEY = 'panergos.desktop.sidebarSortKey'
const SIDEBAR_ROW_META_STORAGE_KEY = 'panergos.desktop.sidebarRowMeta'
const SIDEBAR_CARD_ROWS_STORAGE_KEY = 'panergos.desktop.sidebarCardRows'
const SIDEBAR_SHOW_ALL_SESSIONS_STORAGE_KEY = 'panergos.desktop.sidebarShowAllSessions'
const SIDEBAR_STATUS_FILTER_STORAGE_KEY = 'panergos.desktop.sidebarStatusFilter'
const SIDEBAR_SHOW_ARCHIVED_STORAGE_KEY = 'panergos.desktop.sidebarShowArchived'
const SIDEBAR_PROJECT_FILTER_STORAGE_KEY = 'panergos.desktop.sidebarProjectFilter'
const SIDEBAR_PROFILE_FILTER_STORAGE_KEY = 'panergos.desktop.sidebarProfileFilter'
const SIDEBAR_PR_FILTER_STORAGE_KEY = 'panergos.desktop.sidebarPrFilter'
const SIDEBAR_WORKSPACE_ORDER_STORAGE_KEY = 'panergos.desktop.workspaceOrder'
const SIDEBAR_WORKSPACE_PARENT_ORDER_STORAGE_KEY = 'panergos.desktop.workspaceParentOrder'
const SIDEBAR_PROJECT_ORDER_STORAGE_KEY = 'panergos.desktop.projectOrder'
const SIDEBAR_WORKSPACE_COLLAPSED_STORAGE_KEY = 'panergos.desktop.workspaceCollapsed'
const SIDEBAR_WORKSPACE_NODE_OPEN_STORAGE_KEY = 'panergos.desktop.workspaceNodeOpen'
const SIDEBAR_DISMISSED_AUTO_PROJECTS_STORAGE_KEY = 'panergos.desktop.dismissedAutoProjects'
const SIDEBAR_DISMISSED_WORKTREES_STORAGE_KEY = 'panergos.desktop.dismissedWorktrees'
const PANES_FLIPPED_STORAGE_KEY = 'panergos.desktop.panesFlipped'
...
export const $removedWorktreeIds = persistentAtom('panergos.desktop.removedWorktrees', [] as string[], Codecs.stringArray)
...
export const SESSION_SEARCH_FOCUS_EVENT = 'panergos:focus-session-search'
