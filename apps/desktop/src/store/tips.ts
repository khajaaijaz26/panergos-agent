 ...
 * - It covers Panergos too. "Off" from someone who has just closed a bubble means
...
const ENABLED_KEY = 'panergos.desktop.tips.rotation.v1'

export const $tipsEnabled = persistentAtom(ENABLED_KEY, true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('panergos.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('panergos.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'panergos.desktop.tips.next.v1',
  null,
...
export const $tipShownAt = persistentAtom<Record<string, number>>(
  'panergos.desktop.tips.shownAt.v1',
  {},
  Codecs.json(value => {
