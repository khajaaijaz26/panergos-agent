...
import { getPanergosConfigRecord, type McpTestResult, setMcpServerEnabled, testMcpServer } from '@/panergos'
...
const SNOOZE_KEY_PREFIX = 'panergos:mcp-health-snooze-until:'
...
async function sweep(): Promise<void> {
  ...
  try {
    config = await getPanergosConfigRecord()
  } catch {
