...
function installBridge(
  openSessionWindow?: Window['panergosDesktop']['openSessionWindow'],
  openWindow?: Window['panergosDesktop']['openWindow'],
  openBrowserWindow?: Window['panergosDesktop']['openBrowserWindow']
) {
