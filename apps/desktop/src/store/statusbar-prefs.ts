...
// v1 (`panergos.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'panergos.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'panergos.desktop.statusbarHidden'
// v1 (`panergos.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'panergos.desktop.statusbarVisible.v2'
