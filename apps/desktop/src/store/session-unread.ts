...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('panergos.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('panergos.desktop.unreadFinishedSessions')
