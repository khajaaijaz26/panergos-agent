...
function identityForConnection(connection: PanergosConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: PanergosConnection | null): void {
