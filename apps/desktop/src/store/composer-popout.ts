...
const POPOUT_STORAGE_KEY = 'panergos.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'panergos.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'panergos.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'panergos.desktop.composerPopout.position'
