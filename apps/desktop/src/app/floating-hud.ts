...
// hairline `--stroke-eclipse` paired with the soft `--shadow-eclipse` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-eclipse) bg-(--ui-chat-bubble-background) shadow-eclipse [-webkit-app-region:no-drag]'
