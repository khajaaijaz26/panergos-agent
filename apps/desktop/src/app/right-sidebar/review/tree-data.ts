import type { PanergosReviewFile } from '@/global'
...
export function buildReviewFlatList(files: PanergosReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: PanergosReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
