...
const TAKEOVER_KEY = 'panergos.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Panergos can't clear via the API — the user
 *  sees exactly what runs instead of Panergos silently deleting their creds. */
