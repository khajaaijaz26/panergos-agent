...
const FOCUS_EVENT = 'panergos:composer-focus'
const INSERT_EVENT = 'panergos:composer-insert'
const ATTACH_IMAGES_EVENT = 'panergos:composer-attach-images'
const INSERT_REFS_EVENT = 'panergos:composer-insert-refs'
const SUBMIT_EVENT = 'panergos:composer-submit'
const VOICE_TOGGLE_EVENT = 'panergos:composer-voice-toggle'
const MODEL_MENU_EVENT = 'panergos:composer-model-menu'
