...
describe('ComposerDirectiveActions', () => {
  ...
  it('opens a url in the in-app browser rather than navigating the app', async () => {
    ...
    desktopWindow.panergosDesktop = { openExternal } as unknown as Window['panergosDesktop']
  ...
  it('still hides shortly after the pointer leaves the pill for good', () => {
    ...
    fireEvent.pointerOut(globalThis.document.body, { relatedTarget: globalThis.document.documentElement })
    act(() => {
