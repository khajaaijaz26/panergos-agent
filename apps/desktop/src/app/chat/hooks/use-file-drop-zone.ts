...
import { type DroppedFile, extractDroppedFiles, PANERGOS_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, PANERGOS_PATHS_MIME) ? 'files' : null
