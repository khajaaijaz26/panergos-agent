...
import { savePanergosConfigRecord } from '@/panergos'
...
export function RealProfileConsentDialog({ tabId }: RealProfileConsentDialogProps) {
  ...
  const { data: config } = usePanergosConfigRecord()
  const setConfig = panergosConfigCacheWriter()
  ...
  const enable = useCallback(async () => {
    ...
    try {
      ...
      await savePanergosConfigRecord({ browser: { use_real_profile: true } })
