...
vi.mock('@/panergos', () => ({
  savePanergosConfigRecord: (config: Record<string, unknown>, profile?: unknown) => mocks.save(config, profile)
}))

const promptCopy = {
  title: 'Stay signed in to your sites',
  body: 'Let Panergos browse with a snapshot of your default browser profile.',
...
vi.mock('../../hooks/use-config-record', () => ({
  panergosConfigCacheWriter: () => (config: Record<string, unknown>) => mocks.cache(config),
  usePanergosConfigRecord: () => ({ data: mocks.loadedConfig })
}))
