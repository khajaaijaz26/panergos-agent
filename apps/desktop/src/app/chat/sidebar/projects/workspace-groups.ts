...
import type { ProjectInfo, SessionInfo } from '@/panergos'
 ...
 * repo shows its branches/worktrees even when they have no Panergos sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: PanergosGitWorktree[]
): SidebarSessionGroup[] {
