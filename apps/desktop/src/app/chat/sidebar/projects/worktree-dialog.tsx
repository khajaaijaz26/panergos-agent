...
import type { PanergosGitBranch } from '@/global'
...
const branchActionLabel = (branch: PanergosGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<PanergosGitBranch[]>([])
  ...
  const convert = async (branch: PanergosGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
