...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/panergos'
...
// highlight markers (sqlite snippet() delimiters — see panergos_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('panergos:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('panergos:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Panergos to
