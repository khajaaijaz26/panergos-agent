...
import type * as PanergosApi from '@/panergos'
...
vi.mock('@/panergos', async importOriginal => ({
  ...(await importOriginal<typeof PanergosApi>()),
...
describe('SkillsView toolset management', { timeout: 60_000 }, () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'panergos-skill-pick', name: 'web-research', identifier: 'web-research' },
          origin: 'https://khajaaijaz26.github.io'
        })
      )
    })
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { panergosDesktop?: unknown }).panergosDesktop = { connections, getAgentRoster }
