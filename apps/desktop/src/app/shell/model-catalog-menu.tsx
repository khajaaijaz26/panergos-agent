...
import type { ModelOptionProvider, ModelOptionsResult } from '@panergos/shared'
import { DEFAULT_REASONING_EFFORT } from '@panergos/shared'
...
import { getLocalModelsStatus } from '@/panergos'
...
import type { LocalModelLoadProgress } from '@/types/panergos'
 ...
 * Returning `{}` is fine — the row then shows Panergos' defaults.
 */
