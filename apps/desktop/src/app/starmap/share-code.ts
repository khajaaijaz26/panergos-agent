...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/panergos'
...
const VERSION = 3
const PREFIX = 'HML' // "Panergos Memory Loadout" — namespaces our codes like WoW's leading bytes.
