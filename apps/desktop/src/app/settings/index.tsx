...
import { getPanergosConfigDefaults, getPanergosConfigRecord, savePanergosConfig } from '@/panergos'
...
export function SettingsView({ onClose, onConfigSaved, onMainModelChanged }: SettingsPageProps) {
  ...
  const exportConfig = async () => {
    try {
      const cfg = await getPanergosConfigRecord()
  ...
  const resetConfig = async () => {
    ...
    try {
      await savePanergosConfig(await getPanergosConfigDefaults())
      triggerHaptic('success')
      onConfigSaved?.()
    } catch (err) {
