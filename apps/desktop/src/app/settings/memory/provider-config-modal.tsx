...
import { saveMemoryProviderConfig } from '@/panergos'
import { notify, notifyError } from '@/store/notifications'
import { $activeGatewayProfile } from '@/store/profile'
import type { MemoryProviderConfig, MemoryProviderField } from '@/types/panergos'
          ...
          {config.docs_url && (
            <a
              ...
              onClick={event => {
                ...
                void window.panergosDesktop?.openExternal?.(config.docs_url)
              }}
              rel="noreferrer"
              target="_blank"
            >
