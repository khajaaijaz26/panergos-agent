...
const RELEASE_NOTES_URL = 'https://github.com/khajaaijaz26/panergos-agent/releases'
const INSTALLER_URL = 'https://github.com/khajaaijaz26/panergos-agent#install-from-source'
              ...
              <div className="min-w-0">
                {version?.bundleSwapPending ? (
                  ...
                  <>
                    ...
                    <Button
                      className="mt-2"
                      onClick={() => void window.panergosDesktop?.relaunchApp?.()}
                      size="sm"
                      variant="textStrong"
                    >
                    ...
                    <Button asChild className="mt-2" size="sm" variant="textStrong">
                      <a
                        ...
                        onClick={event => {
                          ...
                          void window.panergosDesktop?.openExternal?.(INSTALLER_URL)
                        }}
                        rel="noreferrer"
                        target="_blank"
                      >
          ...
          <div className="mt-3 flex flex-wrap items-center gap-4">
            ...
            <Button asChild className="ml-auto" size="sm" variant="text">
              <a
                ...
                onClick={event => {
                  event.preventDefault()
                  void window.panergosDesktop?.openExternal?.(RELEASE_NOTES_URL)
                }}
                rel="noreferrer"
                target="_blank"
              >
