...
vi.mock('@/panergos', () => ({
  savePanergosConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setPanergosConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
