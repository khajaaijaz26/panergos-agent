...
const searchCopy = {
  fieldDescriptions: {
    'display.personality': 'Choose how Panergos sounds in conversation.',
...
describe('settings search index', () => {
  it('builds config results from renderable schema fields with exact deep links', () => {
    ...
    } as unknown as PanergosConfigRecord
    ...
    expect(entries[0]).toMatchObject({
      context: 'Chat',
      description: 'Choose how Panergos sounds in conversation.',
      label: 'Personality',
