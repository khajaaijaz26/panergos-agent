...
describe('ConnectionsRegistrySection', () => {
  it('refreshes a cached roster immediately after a successful connection test', async () => {
    ...
    Object.assign(window.panergosDesktop!, { getAgentRoster })
  ...
  it('offers supported kinds on create and disables Local while the managed entry exists', async () => {
    render(<ConnectionsRegistrySection />)
...
describe('dedupe helpers', () => {
  ...
  it('keys remote duplicates on the normalized URL', () => {
    expect(
      findDuplicateConnection(
