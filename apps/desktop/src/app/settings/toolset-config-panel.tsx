 ...
 * server-computed `status` (keys and post-setup install
 ...
 * log inline — the GUI equivalent of the install step `panergos tools` runs
...
/**
 * Backend model catalog — the GUI counterpart of the model picker `panergos
