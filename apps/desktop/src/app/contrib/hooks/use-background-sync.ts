...
import { getLatestSessionMessages, type ProfileScope } from '@/panergos'
...
interface BackgroundSyncParams {
  ...
  refreshPanergosConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshPanergosConfig])
}
