...
// The live-authoring loop: Panergos writes/edits one skin file and every surface
...
describe('ThemeProvider ← backend skin sync', () => {
  ...
  it('paints a persisted backend skin once the connect-time seed makes it resolvable', () => {
    window.localStorage.setItem('panergos-desktop-theme-v2', 'bloomberg')
...
// here as a reference implementation; the shared @panergos/shared/color ladder
