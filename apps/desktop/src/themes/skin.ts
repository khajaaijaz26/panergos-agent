/**
 * Panergos skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$PANERGOS_HOME/skins/` (or a
 * built-in) resolved by `panergos_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Panergos authors from a prompt lights up all three surfaces from one file.
 *
...
import { ensureContrast, mix } from '@panergos/shared/color'
import type { PanergosSkin, SkinColors } from '@panergos/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: PanergosSkin): DesktopTheme | null {
