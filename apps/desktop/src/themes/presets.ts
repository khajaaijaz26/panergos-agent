 ...
 *
 * The imported skins (github, catppuccin, everforest, solarized) are forks
 ...
 *
 *   github     ← github.github-vscode-theme   (Light Default / Dark Default)
 ...
 * re-derived. `eclipse` is Panergos's first-party palette; `legacy-blue`
 * preserves its earlier blue option.
 */

import { THEME_PRESET_PALETTES } from '@panergos/shared'
 ...
 *
 * It remains separately selectable while Panergos ships its own first-party
 * palette as the default.
 */
...
/**
 * Panergos Alt — the hand-authored alternative palette. Light is
 * glass neutrals with brand blue; dark is cream on mission-blue.
 */
export const legacyBlueTheme: DesktopTheme = {
  name: 'legacy-blue',
  label: 'Panergos Alt',
  description: 'Glass neutrals, cream on mission-blue',
  ...THEME_PRESET_PALETTES['legacy-blue'],
  typography: {
    fontSans: SYSTEM_SANS,
    fontMono: SYSTEM_MONO,
    fontUrl: 'https://fonts.googleapis.com/css2?family=Courier+Prime:wght@400;700&display=swap'
...
export const DEFAULT_SKIN_NAME = 'eclipse'
