 ...
 * ensureContrast) live in `@panergos/shared/color` and are shared with the TUI.
 *
...
import { contrastRatio, parseColor, readableOn, relativeLuminance, toHex } from '@panergos/shared/color'
 ...
 * black, which drags chroma down with it — a saturated color mixed toward white
 * to pass AA on a dark surface loses colorfulness and reads
