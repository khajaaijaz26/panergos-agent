 ...
 * plugins resolve `@panergos/plugin-sdk` through the vite alias; RUNTIME-loaded
...
// `sdk/runtime` — so a module-scope `{ __PANERGOS_PLUGIN_SDK__: sdk, … }` is
...
// `Object.keys(GLOBALS.__PANERGOS_PLUGIN_SDK__)` threw
...
function pluginNamespaces() {
  return {
    __PANERGOS_PLUGIN_SDK__: sdk,
    __PANERGOS_REACT__: React,
    __PANERGOS_REACT_JSX__: jsxRuntime,
    __PANERGOS_REACT_JSX_DEV__: jsxDevRuntime
  }
}
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@panergos/plugin-sdk': shimUrl('__PANERGOS_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__PANERGOS_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__PANERGOS_REACT_JSX__'),
    react: shimUrl('__PANERGOS_REACT__')
  }
