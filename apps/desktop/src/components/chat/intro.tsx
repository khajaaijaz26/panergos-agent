...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Panergos look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Panergos need to see?`,
    ...
    {
      headline: `What should ${label} Panergos tackle?`,
