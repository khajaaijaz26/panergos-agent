...
export const PANERGOS_CONTEXT_MENU_TRIGGER_ATTR = 'data-panergos-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-panergos-context-menu-trigger="" />
  )
}
