          ...
          return (
            ...
            >
              <span
                ...
                style={{ color: done ? JADE : undefined, fontFamily: "'JetBrains Mono', monospace" }}
              >
              ...
              >
                ...
                <span
                  className="col-start-1 row-start-1 text-right"
                  style={{ color: JADE_DIM, opacity: done ? 1 : 0, transition: `opacity 400ms ${EASE}` }}
                >
        ...
        >
          ...
          {replying && frame.replyWords < INTRO_REPLY_WORDS.length ? (
            <span
              ...
              style={{ animation: 'intro-caret 0.9s step-end infinite', color: JADE }}
            />
          ) : null}
        </div>
      </div>
          ...
          <div className="min-h-[2rem] px-1.5 pt-0.5 text-[1.02rem] leading-7 text-white/90">
            ...
            {!sent ? (
              <span
                ...
                style={{ animation: 'intro-caret 1.05s step-end infinite', color: JADE }}
              />
            ) : null}
          </div>
      ...
      >
        ...
        >
          ...
          <span
            ...
            style={{ color: JADE_DIM, fontFamily: "'JetBrains Mono', monospace" }}
          >
