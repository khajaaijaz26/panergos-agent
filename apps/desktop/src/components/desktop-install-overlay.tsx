 ...
 *
 * Renders the first-launch install progress for Panergos Agent. Mounted always;
...
export function DesktopInstallOverlay({ enabled = true }: DesktopInstallOverlayProps) {
  ...
  if (state.setupChoice) {
    return (
      <div className="fixed inset-0 z-(--z-setup) flex items-center justify-center bg-background/90 p-4 backdrop-blur-md">
        <div className="w-full max-w-2xl rounded-xl border border-(--stroke-eclipse) bg-card p-8 shadow-eclipse">
  ...
  // there's no Panergos Agent installed yet and we can't drive install.sh
  ...
  if (state.unsupportedPlatform) {
    ...
    return (
      <div className="fixed inset-0 z-(--z-setup) flex items-center justify-center bg-background/90 backdrop-blur-md">
        <div className="w-full max-w-xl rounded-xl border border-(--stroke-eclipse) bg-card p-8 shadow-eclipse">
          ...
          <div className="mt-4">
            ...
            <pre className="overflow-x-auto rounded-md border border-(--stroke-eclipse) px-3 py-2.5 font-mono text-[12px]">
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <Button
                onClick={() => {
                  window.panergosDesktop?.openExternal?.(ups.docsUrl)
                }}
                size="sm"
                variant="ghost"
              >
  ...
  return (
    <div className="fixed inset-0 z-(--z-setup) flex items-center justify-center bg-background/90 backdrop-blur-md p-4">
      <div className="flex w-full max-w-2xl max-h-[90vh] flex-col rounded-xl border border-(--stroke-eclipse) bg-card shadow-eclipse">
            ...
            <div className="flex items-center justify-end">
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    await window.panergosDesktop?.cancelBootstrap?.()
                  } catch {
          ...
          <div className="flex-shrink-0 bg-card p-4">
            <div className="flex items-center justify-between gap-2">
              <span className="text-xs text-muted-foreground">
                ...
                <code className="font-mono text-(--ui-text-secondary)">%LOCALAPPDATA%\panergos\logs\</code>
              </span>
              <div className="flex gap-2">
                ...
                <Button
                  onClick={async () => {
                    ...
                    try {
                      await window.panergosDesktop?.resetBootstrap?.()
                    } catch {
