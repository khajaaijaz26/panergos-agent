 ...
 */
export const $activePresetId = atom<string>(readKey('panergos.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('panergos.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'panergos.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'panergos.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'panergos.desktop.hiddenStripTabs.v1'
...
writeKey('panergos.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__PANERGOS_LAYOUT_TREE__ = {
    close: closeTreePane,
