...
// Connectors are the apps Panergos reads and acts on for the user. Chat channels
// (Discord, Telegram, WhatsApp) are how a user talks to Panergos; those live on
...
// the active skin as soon as the swatch is clicked. Panergos coral is the default
// and sets no override. Mono is black in light mode and white in dark mode.
export const PANERGOS_ACCENT = '#ff6b5e'
...
export const accentsFor = (dark: boolean): Array<{ hex: string; name: string }> => [
  ...
  { hex: PANERGOS_ACCENT, name: 'Panergos coral' },
