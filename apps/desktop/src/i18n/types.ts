...
export interface Translations {
  ...
  boot: {
    ...
    steps: {
      ...
      startingPanergosDesktop: string
    }
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshPanergosPathTitle: string
      sshPanergosPathDesc: string
      sshPanergosPathPlaceholder: string
  ...
  commandCenter: {
    ...
    panergosActiveSessions: (version: string, count: number) => string
