...
export const en: Translations = {
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want Panergos to use.',
    connectTitle: app => `Connect ${app}?`,
    describe: app => `Panergos signs in to ${app} in your browser and asks before reading anything there.`,
    execution: 'Connector tools'
  },

  sessionImport: {
    title: 'Continue from another app',
    subtitle: 'Bring a conversation into Panergos and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Panergos.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Panergos. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Panergos',
    continue: 'Continue in Panergos',
  ...
  boot: {
    ready: 'Panergos Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Panergos settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Panergos backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingPanergosDesktop: 'Starting Panergos Desktop…'
    },
    errors: {
      backgroundExited: 'Panergos background process exited.',
      backgroundExitedDuringStartup: 'Panergos background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Panergos backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updatePanergos: 'Update Panergos',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Panergos Desktop.',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Could not hand the request to Panergos',
    ...
    native: {
      ...
      inputBody: 'Panergos is waiting for your response.',
      turnDoneTitle: 'Panergos finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Panergos defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Panergos catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, Panergos generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; Panergos picks it up automatically.`,
        disabledDesc: 'Detected but turned off for Panergos.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when Panergos closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Panergos is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Panergos asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Panergos was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Panergos was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Panergos follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Panergos can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'Occasional hints from the app and Panergos. Each tip appears once. Turns off automatically after your first 30 days; you can turn it back on.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc:
        'Let Panergos spotlight each step as it guides you through the app. Turns off automatically after your first 30 days; you can turn it back on.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Panergos is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Panergos, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    uninstallSection: {
      ...
      uninstallPanergos: 'Uninstall Panergos'
    },
    poolLimits: {
    ...
    about: {
      heading: 'Panergos Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Panergos runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Panergos only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Panergos',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Panergos checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Panergos configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Panergos.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Panergos gateway it can reach through remote or SSH connections.',
      stagedNote:
      ...
      kindSsh: 'SSH',
      kindLocalDesc: 'The Panergos runtime managed by this app.',
      kindRemoteDesc: 'A Panergos gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindSshDesc: 'A Panergos install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values follow the saved-secret encryption setting. Headers Panergos manages (Authorization, Cookie, Host…) are ignored.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Panergos backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset PANERGOS_DESKTOP_REMOTE_URL and PANERGOS_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Panergos backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Panergos backend.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /panergos.',
      ...
      restartingMessage: 'Panergos Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Panergos ${version}` : ''}`,
      ...
      sshDesc:
        'Panergos is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshPanergosPathTitle: 'Panergos path (optional)',
      sshPanergosPathDesc: 'Full path to the remote Panergos binary. Blank = auto-detect.',
      sshPanergosPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Panergos found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Panergos runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Panergos is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/khajaaijaz26/panergos-agent/main/scripts/install.sh | sh) or set the Panergos path.',
      sshErrPlatform:
        'Unsupported remote platform. Panergos Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Panergos on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Panergos. Review the exact configuration below — it comes from the link, not from Panergos.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Panergos starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Panergos ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Panergos runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Panergos browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via panergos curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      defaultProfile: 'Panergos (default)',
      kindAgent: 'Agent',
      kindDesktop: 'Desktop',
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update Panergos to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the Panergos catalog${sha ? ` at pin ${sha}` : ''}.`,
  ...
  starmap: {
    ...
    emptyDesc: 'As Panergos builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Panergos to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Panergos to generate pets.',
      backgroundHint: 'You can close this — Panergos will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Panergos desktop' },
    ...
    panergosActiveSessions: (version, count) => `Panergos ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle: 'Manual BotFather setup is the recommended local path. QR setup uses an external onboarding service.',
      quickSetup: 'Optional external QR setup',
      recommended: 'External service',
      quickHelp:
        'Available only when TELEGRAM_ONBOARDING_URL points to an operator-chosen compatible onboarding service. That service receives the requested bot display name and returns a bot token and Telegram user ID after confirmation.',
      createWithQr: 'Start external QR setup',
      starting: 'Starting…',
      replaceWarning:
    ...
    fieldCopy: {
      TELEGRAM_BOT_TOKEN: {
        label: 'Bot token',
        help: 'Recommended local setup. Create or choose a bot with @BotFather, then paste its token; Panergos stores it in this installation.',
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@panergos:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Panergos you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://panergos.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Panergos environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Panergos did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Panergos will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Panergos backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Panergos. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Panergos backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Panergos...',
    placeholderReconnecting: 'Reconnecting to Panergos…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Panergos a task',
      "What's on your mind?",
    ...
    voiceEngineChained: 'Speech-to-text + Panergos voice',
    voiceEngineLive: 'GPT-Live (full-duplex, delegates to Panergos)',
    ...
    attachUrlDesc: 'Panergos will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Panergos to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Panergos…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Panergos…',
    ...
    unsupportedMessage: 'This version of Panergos can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Panergos from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Panergos will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Panergos desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Panergos updater takes over in its own window and reopens Panergos automatically when it’s done. Please don’t reopen Panergos yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Panergos reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Panergos reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Panergos?',
    blockerBody:
      'Panergos needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Panergos',
    foreignBlockerBody:
      'Panergos can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Panergos can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  handoffTour: {
    ...
    stayTitle: 'Panergos is one click away',
    stayText: 'Switch to the setup profile and open Welcome to Panergos whenever you want a hand. It stays there.'
  },
  guidedGreeting: {
    line: "Hey, come on in. I'm Panergos. Give me two minutes to set the place up around you, then we'll put me to work on something you actually want done.\n\nFirst though, what should I call you?",
  ...
  install: {
    ...
    oneTimeTitle: 'Panergos needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Panergos Desktop',
    setupChoiceDesc:
      'Connect this app to a Panergos gateway you already run, or install Panergos locally on this computer.',
    connectExistingTitle: 'Connect to existing Panergos',
    ...
    installLocalTitle: 'Install Panergos locally',
    installLocalDesc: 'Download Panergos, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Panergos Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Panergos',
    remoteSetupDesc: 'Enter your gateway URL. Panergos Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Panergos gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/panergos',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Panergos gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Panergos Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Panergos CLI or desktop instance is running. Stop any running Panergos instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Panergos Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Panergos is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Panergos…',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Panergos at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Panergos connects automatically',
    ...
    authorizeThere: 'Authorize Panergos there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Panergos there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    unavailable: 'Unavailable',
    unavailableHint: 'This model is unavailable for the current provider.',
    free: 'Free',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Panergos Desktop v${version}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Panergos will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Panergos is restarting...',
      askRestart: 'Ask Panergos to restart the server',
      lookingRestart: taskId => `Panergos is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Panergos is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Panergos to open a page.',
      finishedRestarting: message => `Panergos finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Panergos could not restart the server.',
      stillWorking:
        'Panergos is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Panergos is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Panergos gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.panergos/config.yaml). Panergos won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Panergos needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Panergos needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `Panergos reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and Panergos types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and Panergos enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Panergos Desktop to use Save Image.',
    restartToSaveImages: 'Restart Panergos Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `panergos gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Panergos loads when the work calls for them.'
      },
      messaging: {
        title: 'Panergos away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Panergos made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Panergos — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
