...
import type { LocalCatalogModel, LocalModelsStatus } from '@/types/panergos'
 ...
 *
 * `connectionMode` must be 'local': on a remote backend the models would run
 * on the far machine, and a bubble promising
