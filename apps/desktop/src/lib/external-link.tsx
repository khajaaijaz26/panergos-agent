...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|panergos):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.panergosDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.panergosDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Panergos, and it is the surface the agent
