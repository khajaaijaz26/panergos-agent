...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/panergos-agent')).toBe('~/www/panergos-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/panergos-agent')).toBe('panergos-agent')
    expect(pathLeaf('~/www/panergos-agent')).toBe('panergos-agent')
