...
// Query-key roots that are NOT profile-scoped: the theme marketplace,
// onboarding, and contrib log tails all read global state, so a
// profile/gateway swap must not refetch them. Any
...
// refetched every global and profile-scoped surface on each switch.
