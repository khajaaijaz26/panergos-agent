import type { ModelCapabilities, ModelOptionProvider, ModelOptionsResult } from '@panergos/shared'

import { getGlobalModelOptions, type PanergosGateway } from '@/panergos'
