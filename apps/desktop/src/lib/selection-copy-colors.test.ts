...
describe('installSelectionCopyColorGuard', () => {
  beforeEach(() => {
    document.documentElement.dataset.panergosMode = 'dark'
  })

  afterEach(() => {
    delete document.documentElement.dataset.panergosMode
    window.getSelection()?.removeAllRanges()
  })
  ...
  it('leaves light-ink selections alone when the theme is light', () => {
    document.documentElement.dataset.panergosMode = 'light'
