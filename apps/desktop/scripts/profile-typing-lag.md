...
cd apps/desktop
XCURSOR_SIZE=24 PANERGOS_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/panergos-typing
# → /tmp/panergos-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/panergos-typing.before.heapsnapshot
# → /tmp/panergos-typing.after.heapsnapshot
```
