...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @panergos/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@panergos/shared'],
              message: 'Plugins import only @panergos/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
