 ...
 *
 * Historically each line was prefixed with just `[panergos] `; Panergos keeps
 * the timestamped shape while using its own public diagnostic identity.
 * Lines from different moments were indistinguishable. Every surface now carries an
