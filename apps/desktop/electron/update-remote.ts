 ...
 *
 * A public install can end up with `origin=git@github.com:khajaaijaz26/panergos-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/khajaaijaz26/panergos-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/khajaaijaz26/panergos-agent'
