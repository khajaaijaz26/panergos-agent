...
// even though a fresh shell — and the Panergos CLI — sees it immediately. The
// desktop's PANERGOS_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\panergos. Reading
...
//       PANERGOS_HOME    REG_SZ    F:\Panergos\data
//
