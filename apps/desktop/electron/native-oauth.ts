 ...
 * Apps) login to a gated Panergos gateway: system-browser + loopback redirect +
 ...
 * upstream identity provider issues a per-gateway-instance client_id and only
...
// panergos_cli/web_server.py status handler.
