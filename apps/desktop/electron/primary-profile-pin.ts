 ...
 *     it via `panergos:profile:remember` without re-homing the primary.
 ...
 * the same PANERGOS_HOME. That duplicate held a pool slot and starved every other
...
export class PrimaryProfilePin {
  ...
  /** Called by startPanergos() with the profile the primary is launching as. */
