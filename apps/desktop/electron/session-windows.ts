...
// by main.ts (`setBackgroundThrottling` driven by the merged `panergos:active-work`
...
// (the "Panergos idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Panergos" wake word has NO preceding click,
