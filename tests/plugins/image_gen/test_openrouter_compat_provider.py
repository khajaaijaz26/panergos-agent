#!/usr/bin/env python3
"""Tests for the OpenRouter-compatible image generation provider."""
...
class TestImageApiSurface:
    ...
    def test_catalog_models_are_offered_by_openrouter(self):
...
class TestRegistration:
    def test_registers_openrouter(self):
