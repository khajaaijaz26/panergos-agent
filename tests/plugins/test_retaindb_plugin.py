...
def _isolate_env(tmp_path, monkeypatch):
    """Ensure PANERGOS_HOME and RETAINDB vars are isolated."""
...
class TestRetainDBMemoryProvider:
    ...
    def test_initialize_creates_client_and_queue(self, tmp_path, monkeypatch):
        ...
        p.initialize("test-session", panergos_home=str(tmp_path / ".panergos"))
...
class TestPrefetch:
    ...
    def _make_initialized_provider(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("PANERGOS_HOME", str(panergos_home))
        p = RetainDBMemoryProvider()
        p.initialize("test-session", panergos_home=str(panergos_home))
        return p
