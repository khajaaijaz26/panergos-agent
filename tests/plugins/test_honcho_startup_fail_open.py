...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "panergos honcho peer --user", "Do not suggest peerName"),
    ("telegram", "Do not suggest peerName", "panergos honcho peer --user"),
])
...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "panergos honcho peer --user", "could not be initialized"),
    ("discord", "supplied no user id", "panergos honcho peer --user"),
])
