...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and panergos-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # panergos-agent (tests/skills/)
]
