...
Prior to this change, aggregator users (OpenRouter / example Portal) had aux
...
class TestResolveVisionMainFirst:
    ...
    def test_copilot_vision_sets_vision_header(self, monkeypatch):
        ...
        with patch(
            ...
            "panergos_cli.copilot_auth.copilot_request_headers",
...
class TestResolveVisionCustomProvider:
    ...
    it returns ``(None, None)`` and vision falls through to OpenRouter / example,
