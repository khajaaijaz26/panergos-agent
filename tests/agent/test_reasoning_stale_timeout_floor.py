...
thinking phase.  Panergos's default cloud-stream stale detector
(``PANERGOS_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``PANERGOS_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
