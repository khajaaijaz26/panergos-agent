...
class TestSummarizeToolResultClarify:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # panergos_cli/oneshot.py no-user callback
    ...
    def test_live_oneshot_producer_is_recognized_as_sentinel(self):
        ...
        from panergos_cli.oneshot import _oneshot_clarify_callback
...
class TestAuthFailureAborts:
    ...
    Real incident: a example token pointed at a stale staging inference URL
    ...
    def test_missing_provider_api_key_preserves_original_messages(self):
        ...
        err = RuntimeError(
            ...
            "to a different provider with panergos model."
        )
        with patch(
...
class TestTruncateToolCallArgsJson:
    ...
    def test_shrunken_args_remain_valid_json(self):
        ...
        original = _json.dumps({
            "path": "~/.panergos/skills/shopping/browser-setup-notes.md",
        ...
        assert parsed["path"] == "~/.panergos/skills/shopping/browser-setup-notes.md"
