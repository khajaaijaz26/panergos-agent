...
class TestCleanStreamEndMidToolCall:
    ...
    NO [DONE].  Observed live on NVIDIA Nemotron Ultra via the example dedicated
...
class TestStreamIncludeUsageFinalChunk:
    ...
    Panergos must recognize that the presence of usage proves the stream completed
