...
def test_skip_flags_replace_the_isinstance_checks_for_in_and_out_of_tree_clients():
    ...
    assert CopilotACPClient.PANERGOS_SKIP_TRANSPORT_WRAP and CopilotACPClient.PANERGOS_SKIP_ASYNC_WRAP
    assert GeminiNativeClient.PANERGOS_SKIP_TRANSPORT_WRAP
    assert not getattr(GeminiNativeClient, "PANERGOS_SKIP_ASYNC_WRAP", False)
