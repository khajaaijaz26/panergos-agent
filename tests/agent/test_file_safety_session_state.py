...
manipulation. Panergos keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point PANERGOS_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_panergos_home /
    get_default_panergos_root) instead of monkeypatching private helpers —
    ...
    PANERGOS_HOME=<root>/profiles/<name> makes get_default_panergos_root()
