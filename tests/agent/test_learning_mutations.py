...
against a temp PANERGOS_HOME, never mocks — the id→file mapping is the whole point.
"""
...
def test_parse_node_kind():
    ...
    assert lm.parse_node_kind("debugging-panergos") == "skill"
