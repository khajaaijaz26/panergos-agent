...
Reports live under ``~/.panergos/logs/curator/{YYYYMMDD-HHMMSS}/`` alongside
...
def curator_env(tmp_path, monkeypatch):
    """Isolated PANERGOS_HOME with a skills/ dir + reset curator module state."""
...
def curator_env_with_cron(curator_env, monkeypatch):
    ...
    monkeypatch.setattr(jobs_mod, "PANERGOS_DIR", home)
