...
def make_panergos_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated PANERGOS_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"panergos-home-{journal_mode}"
