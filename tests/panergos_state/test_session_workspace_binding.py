"""Session <-> workspace grouping key (panergos_state_sessions.workspace_key).

The key is what `panergos sessions list --workspace` groups/filters on. It is a
...
import panergos_state_sessions
from panergos_state_sessions import workspace_key
