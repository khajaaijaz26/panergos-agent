"""Tests for the interactive session browser (`panergos sessions browse`).
...
from panergos_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """panergos sessions browse should be parseable."""
