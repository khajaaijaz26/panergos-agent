...
class TestXiaomiCredentials:
    ...
    def test_resolve_credentials_reads_home_external_secret_scope(
        ...
        from panergos_cli import env_loader
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in PANERGOS_OVERLAYS
        overlay = PANERGOS_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify panergos doctor recognizes Xiaomi env vars."""
