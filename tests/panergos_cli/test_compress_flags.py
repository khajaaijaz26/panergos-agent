...
Covers the pure helpers in ``panergos_cli.partial_compress`` plus alias
...
from panergos_cli.commands import COMMANDS, resolve_command
from panergos_cli.partial_compress import (
    DEFAULT_KEEP_LAST,
