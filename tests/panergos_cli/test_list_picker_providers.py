...
import panergos_cli.model_switch_providers as panergos_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(panergos_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("panergos_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import panergos_cli.models as hm
    import panergos_cli.models_catalog_static as panergos_cli_models_catalog_static
    from panergos_cli import models_catalog_static
    ...
    monkeypatch.setattr(panergos_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
