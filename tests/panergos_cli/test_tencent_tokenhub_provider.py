...
# =============================================================================
# CANONICAL_PROVIDERS (panergos model picker)
# =============================================================================
...
# =============================================================================
# OpenRouter / example Portal curated lists
# =============================================================================
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_matching_prefix_strip_set(self):
        ...
        copy vendor/ form."""
        from panergos_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from panergos_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in PANERGOS_OVERLAYS
        overlay = PANERGOS_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from panergos_cli.providers import PANERGOS_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = PANERGOS_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubApiMode:
    ...
    def test_determine_api_mode_via_alias(self):
        from panergos_cli.providers import determine_api_mode
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_alias_known(self, alias):
        from panergos_cli.models import _KNOWN_PROVIDER_NAMES
