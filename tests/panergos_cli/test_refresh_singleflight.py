...
from panergos_cli.dashboard_auth import refresh_singleflight as replay
from panergos_cli.dashboard_auth.base import ProviderError, RefreshExpiredError, Session
from panergos_cli.dashboard_auth.routes import router
...
def test_cookie_gate_burst_with_stale_rt_rotates_once(gated_web_app):
    ...
    cookies = {"panergos_session_at": "expired-at", "panergos_session_rt": "stale-rt",
               "panergos_session_provider": "stub"}
