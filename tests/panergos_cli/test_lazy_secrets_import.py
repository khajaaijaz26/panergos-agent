"""Regression test: panergos update must not load cryptography eagerly."""
...
assert 'panergos_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running panergos update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so panergos_cli is importable,
