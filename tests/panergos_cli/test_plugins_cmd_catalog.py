"""Catalog-aware ``panergos plugins`` surface (panergos_cli/plugins_cmd_catalog.py): a bare catalog name installs
...
from panergos_cli import plugins_cmd_catalog as cat
