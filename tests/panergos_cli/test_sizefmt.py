"""Tests for the shared byte formatter (panergos_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from panergos_cli.backup import _format_size as backup
    from panergos_cli.checkpoints import _fmt_bytes as checkpoints
    from panergos_cli.sizefmt import format_bytes as doctor
