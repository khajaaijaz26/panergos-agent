"""``panergos profile create --clone`` leaves messaging channels behind (``panergos_cli.profile_channels``).
...
def test_clone_is_published_atomically_after_stripping(home, monkeypatch):
    ...
    from panergos_cli import profile_channels, profiles
    seen = {}
...
def test_clone_channels_refusal_lives_in_create_profile(home, monkeypatch):
    ...
    from panergos_cli import gateway_multiplex_served as served_mod
