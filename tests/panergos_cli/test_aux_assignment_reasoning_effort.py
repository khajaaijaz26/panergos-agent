...
from panergos_cli.web_server_config import _UNSET, _apply_aux_assignment_sync


@pytest.fixture
def saved(monkeypatch):
    store: dict = {}
    monkeypatch.setattr("panergos_cli.config.save_config", lambda cfg: store.update(cfg))
    return store
