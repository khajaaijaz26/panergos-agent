"""Tests for Blank Slate setup mode (panergos_cli/setup.py).
...
from panergos_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
...
class TestBlankSlateFork:
    ...
    def _patch_common(self, monkeypatch):
        import panergos_cli.setup as s
