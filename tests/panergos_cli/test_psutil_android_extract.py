...
from panergos_cli.psutil_android import (
    MARKER,
    REPLACEMENT,
    PSUTIL_URL,
...
def test_install_psutil_android_compat_uses_patched_tree(tmp_path):
    ...
    with patch("urllib.request.urlretrieve", side_effect=fake_urlretrieve), \
         patch.object(panergos_main, "_run_install_with_heartbeat", side_effect=fake_run_install):
    ...
    assert captured["env"] == {"PANERGOS_TEST": "1"}
