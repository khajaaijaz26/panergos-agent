"""Tests for panergos_cli.session_filters — CLI time/filter parsing for
`panergos sessions prune` / `panergos sessions archive`."""
...
from panergos_cli.session_filters import (
    build_prune_filters,
    describe_filters,
