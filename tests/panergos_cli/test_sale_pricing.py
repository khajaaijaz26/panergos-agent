...
from panergos_cli.models_pricing import compute_sale_discount, fetch_models_with_pricing
...
def test_free_model_gets_flat_100_percent_discount():
    ...
    # "0.0000000000" strings (example portal shape) count as free too.
...
def test_fetch_models_with_pricing_copies_nested_original(monkeypatch):
    ...
    # example Portal opts in via include_sale_original=True.
