from panergos_cli.main_provider_setup import _prompt_reasoning_effort_selection
...
def test_reasoning_menu_orders_minimal_before_low(monkeypatch):
    ...
    monkeypatch.setattr("panergos_cli.curses_ui.curses_radiolist", _fake_radiolist)
