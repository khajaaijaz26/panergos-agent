...
from panergos_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/panergos_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("panergos_cli.lifecycle.invoke_hook")
@patch("panergos_cli.lifecycle.finalize_session")
