"""Tests for ``panergos approvals suggest`` (panergos_cli/approvals_suggest.py).

Approval history in Panergos is implied, not ledgered: the session DB
...
from panergos_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
