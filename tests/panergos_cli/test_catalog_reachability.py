...
Run before any catalog commit:
    ...
    PANERGOS_TEST_NETWORK=1 scripts/run_tests.sh tests/panergos_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("PANERGOS_TEST_NETWORK"),
    reason="network test; set PANERGOS_TEST_NETWORK=1 to run",
)
