"""Test the platform-branched PTY bridge import in panergos_cli.web_server_chat.
...
def test_web_server_uses_posix_pty_bridge_on_posix():
    ...
    from panergos_cli.pty_bridge import PtyBridge as PosixBridge
    from panergos_cli.pty_bridge import PtyUnavailableError as PosixErr
...
def test_pty_bridge_import_block_is_platform_branched():
    ...
    from panergos_cli import web_server_chat
    ...
    #       try:
    #           from panergos_cli.win_pty_bridge import WinPtyBridge as PtyBridge, ...
    #       except ImportError:
    #           PtyBridge = None
    #           ...
    #   else:
    ...
    assert "from panergos_cli.win_pty_bridge import" in src
    assert "from panergos_cli.pty_bridge import" in src
