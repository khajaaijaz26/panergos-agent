...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (panergos_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_panergos_overlays():
    """panergos_cli.providers.get_provider("vertex") backs
