"""Tests for the `panergos proxy` subcommand and its upstream adapters."""
...
from panergos_cli.proxy.adapters.xai import XAIGrokAdapter
...
def _write_xai_pool_entry(
    ...
    *,
    ...
    """Write an xai-oauth pool entry into a hermetic PANERGOS_HOME."""
...
def test_xai_adapter_retry_rotates_pool_entry_on_429(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("panergos_cli.auth.refresh_xai_oauth_pure", _refresh_must_not_run)
...
from panergos_cli.proxy.server import create_app  # noqa: E402
