...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (PANERGOS_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via PANERGOS_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in PANERGOS_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from panergos_cli.providers import PANERGOS_OVERLAYS
        assert "bedrock" in PANERGOS_OVERLAYS
