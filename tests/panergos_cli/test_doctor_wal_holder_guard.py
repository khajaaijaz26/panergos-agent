"""Regression: ``panergos doctor --fix`` must not checkpoint the live WAL under a running gateway.
...
# that depend on Panergos *choosing* WAL mode (declined on vulnerable SQLite
