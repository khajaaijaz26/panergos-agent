"""Tests for panergos_cli.foreign_sessions — Claude Code / Codex CLI import.

Fixture JSONL is synthesized inline (tmp_path); the SessionDB is opened
against a temp path so nothing touches the real PANERGOS_HOME store.
"""
...
from panergos_cli.foreign_sessions import (
    _list_sessions,
