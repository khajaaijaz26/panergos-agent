"""Tests for `_can_open_graphical_browser()` in panergos_cli.auth.

Guards the fix for the May 2026 report where `panergos auth add xai-oauth`
...
from panergos_cli.auth import _can_open_graphical_browser
