...
only when every damaged object is a Panergos FTS shadow.
"""
...
from panergos_cli.doctor_state import _state_db_health
from panergos_state import SessionDB
from panergos_state_repair import integrity_damage_is_structural, state_db_has_structural_damage
...
def test_doctor_routes_structural_damage_to_recover_not_fts_rebuild(tmp_path, monkeypatch):
    ...
    .malformed-backup, nothing fixed) and must point at `panergos sessions recover` for THIS
