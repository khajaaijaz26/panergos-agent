...
example ``/v1/models`` answers each caller with the catalog their org may reach,
...
from panergos_cli.models_pricing import fetch_models_with_pricing, peek_cached_pricing
