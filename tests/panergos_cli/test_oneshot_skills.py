...
The oneshot path builds its AIAgent directly (bypassing PanergosCLI), so the
...
from panergos_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
