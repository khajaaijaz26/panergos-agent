...
class TestGetCopilotModelContext:
    ...
    @patch("panergos_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("panergos_cli.models._urlopen_model_catalog_request")
    ...
    @patch("panergos_cli.models.fetch_github_model_catalog", return_value=[])
