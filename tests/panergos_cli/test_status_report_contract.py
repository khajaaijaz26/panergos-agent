...
Every surface renders through ``panergos_cli.status_report.build_status_fields``; each keeps
...
def test_three_status_surfaces_report_the_same_common_fields():
    with patch("panergos_constants.display_panergos_home", return_value=HOME), \
