"""Fetch-failure classification for `panergos update` / `panergos update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/khajaaijaz26/panergos-agent.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `panergos update` sit on
    ...
    from panergos_cli import update_cmd_git
