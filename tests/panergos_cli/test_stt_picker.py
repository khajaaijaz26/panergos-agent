"""Tests for the Speech-to-Text category in `panergos tools` (tools_config).
...
from panergos_cli.tools_config import (  # noqa: E402
...
class TestModelPicker:
    ...
    def test_configure_stt_model_defaults_to_current(self):
        ...
        with patch(
            "panergos_cli.tools_config._prompt_choice", return_value=0
        ) as pc:
...
class TestPostSetup:
    def test_faster_whisper_in_post_setup_ready(self):
        from panergos_cli.tools_config import _POST_SETUP_READY
