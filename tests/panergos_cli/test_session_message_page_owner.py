...
def test_message_pages_identify_the_serving_profile(tmp_path, monkeypatch, serving_profile):
    ...
    monkeypatch.setenv("PANERGOS_HOME", str(work_home))
    # conftest redirects this legacy override independently of PANERGOS_HOME.
    monkeypatch.setattr("panergos_state.DEFAULT_DB_PATH", work_home / "state.db")
    ...
    from panergos_cli.web_routers.sessions import manage_router
