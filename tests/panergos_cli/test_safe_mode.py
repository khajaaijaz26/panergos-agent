"""Tests for `panergos chat --safe-mode` isolation."""
...
_VARS = ("PANERGOS_SAFE_MODE", "PANERGOS_IGNORE_USER_CONFIG", "PANERGOS_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["PANERGOS_SAFE_MODE"] == "1"
        assert os.environ["PANERGOS_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["PANERGOS_IGNORE_RULES"] == "1"
        return True
