"""Tests for the shared tar.gz writer (``panergos_cli.archive_safe.make_targz``).

``make_targz`` backs both ``panergos profile export`` and ``panergos kanban
...
from panergos_cli.archive_safe import make_targz
