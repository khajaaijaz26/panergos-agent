"""Tests for the specifier module + `panergos kanban specify` CLI surface.
...
from panergos_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `panergos kanban …` argparse surface directly."""
