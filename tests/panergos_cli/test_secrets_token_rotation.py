"""Tests for `panergos secrets bitwarden token` / `panergos secrets onepassword token`.
...
from panergos_cli import onepassword_secrets_cli as op_cli
from panergos_cli import secrets_cli as bw_cli
