...
def test_monitor_shortcuts_preserve_draft_and_respect_modal_prompts(monkeypatch):
    ...
    from panergos_cli import cli_subagent_monitor as monitor
    ...
    monkeypatch.setenv('PANERGOS_DEFER_AGENT_STARTUP', '1')
    cli = PanergosCLI(model='fixture', provider='openai-compat', api_key='fixture',
