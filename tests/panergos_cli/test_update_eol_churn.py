"""Regression: ``panergos update`` should take a managed checkout off autocrlf=true.
...
``panergos update`` has to repair them.
...
from panergos_cli.update_cmd import _normalize_managed_eol
