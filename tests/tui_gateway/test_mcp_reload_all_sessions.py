...
def reload_env(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(_mcp_discovery, "discover_mcp_tools",
                        lambda: discovered_homes.append(panergos_constants.panergos_home_key()))
...
def test_reload_rediscovers_under_each_live_profile_scope(reload_env):
    ...
    assert panergos_constants.panergos_home_key() in reload_env.discovered_homes
    assert panergos_constants.panergos_home_key(reload_env.profile_b) in reload_env.discovered_homes
