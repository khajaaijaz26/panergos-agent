...
The unit tests in tests/panergos_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned panergos-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/panergos")
from panergos_cli.service_manager import S6ServiceManager
