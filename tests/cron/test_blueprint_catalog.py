...
the shared /blueprint command handler (panergos_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated PANERGOS_HOME for anything that touches the
cron job store.
"""
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("panergos://blueprint/morning-brief?")
