    ...
    def test_extracts_quoted_absolute_path(self):
        ...
        assert (
            _extract_screenshot_path_from_text(
                "Screenshot saved to '/Users/david/.panergos/browser_screenshots/shot.png'"
            )
            == "/Users/david/.panergos/browser_screenshots/shot.png"
        )
...
class TestInactivityJanitorMultiplex:
    ...
    def test_janitor_tears_down_under_owner_profile_scope(self, tmp_path, monkeypatch):
        ...
        from panergos_constants import (
            get_panergos_home, reset_panergos_home_override, set_panergos_home_override,
        )
        ...
        home_tok = set_panergos_home_override(str(p1))
