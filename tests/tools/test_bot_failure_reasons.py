...
FIXTURE_NO_PROVIDER = (
    "agent init failed: No LLM provider configured. Run `panergos model` to select "
    "a provider, or run `panergos setup` for first-time configuration."
)
FIXTURE_NO_TOKEN = "agent init failed: No access token found for example Portal login."
