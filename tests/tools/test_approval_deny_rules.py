...
def clean_env(monkeypatch):
    ...
    for var in ("PANERGOS_YOLO_MODE", "PANERGOS_GATEWAY_SESSION",
                "PANERGOS_CRON_SESSION", "PANERGOS_INTERACTIVE",
                "PANERGOS_EXEC_ASK"):
...
class TestDenyOrdering:
    ...
    def test_container_backend_cannot_skip_deny(
        ...
        result = guard("chmod 600 /tmp/panergos-approval-deny-test", env_type)
