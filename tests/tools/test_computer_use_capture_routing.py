...
* ``panergos_constants.get_panergos_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_panergos_dir so cache writes land under tmp_path."""
    ...
    with patch("panergos_constants.get_panergos_dir", _fake_get):
        yield cache_dir
