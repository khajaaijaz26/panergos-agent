...
Real config files in a temp PANERGOS_HOME, real resolution chains (no mocked
...
def voice_home(tmp_path, monkeypatch):
    """Isolated PANERGOS_HOME + reloaded config modules; yields a config writer."""
    ...
    for var in (
        ...
        "DEEPINFRA_API_KEY", "PANERGOS_LOCAL_STT_LANGUAGE",
    ):
