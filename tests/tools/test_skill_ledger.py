...
def ledger_env(tmp_path, monkeypatch):
    """Isolated PANERGOS_HOME + skills dir for skill_manage and the ledger."""
    ...
    monkeypatch.setattr(skill_ledger, "get_panergos_home", lambda: home)
    monkeypatch.setattr(skill_usage, "get_panergos_home", lambda: home)
...
def test_rollback_refuses_paths_outside_panergos_home(ledger_env):
    """A hand-edited ledger entry pointing outside PANERGOS_HOME must not
