...
Coverage:
  _tavily_request() â€” keyed Bearer vs keyless header, attribution, error bodies.
  _normalize_tavily_search_results() â€” search response normalization.
  _normalize_tavily_documents() â€” extract response normalization, failed_results.
  web_search_tool / web_extract_tool â€” Tavily dispatch paths.
  auto-detect ranking â€” keyed paid-band; keyless only when Tavily is selected.
"""
...
# â”€â”€â”€ _tavily_request â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

class TestTavilyRequest:
    """Test suite for the _tavily_request helper."""

    def test_keyless_when_no_api_key(self):
        """No TAVILY_API_KEY â†’ keyless header, no Authorization, no body key."""
        ...
        with patch.dict(os.environ, {}, clear=False):
            ...
            with patch("plugins.web.tavily.provider.httpx.post", return_value=mock_response) as mock_post:
                ...
                assert headers["X-Client-Name"] == "panergos-agent"
    ...
    def test_keyed_uses_bearer_not_body(self):
        """TAVILY_API_KEY â†’ Bearer auth, attribution, no body api_key."""
        mock_response = _ok_response()
...
# â”€â”€â”€ _normalize_tavily_search_results â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ _normalize_tavily_documents â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ availability / auto-detect â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestTavilyAvailability:
    ...
    def test_no_keys_defaults_to_firecrawl(self):
        ...
        firecrawl sentinel. (With the tier on â€” the default â€” it resolves
...
# â”€â”€â”€ web_search_tool (Tavily dispatch) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ web_extract_tool (Tavily dispatch) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
