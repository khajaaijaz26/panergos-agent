...
def test_one_shot_cli_preserves_refusal_reason(monkeypatch, capsys):
    ...
    assert not PanergosCLI._claim_active_session(cli, stderr=True)
    assert "panergos-refusal-reason: SESSION_NOT_OWNED\n" in capsys.readouterr().err
