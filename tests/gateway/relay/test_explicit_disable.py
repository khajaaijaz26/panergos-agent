...
Real profile files under a temp PANERGOS_HOME, the production startup hook and the
...
SPELLINGS = {
    ...
    "managed": None,  # user YAML absent; disable comes from PANERGOS_MANAGED_DIR
}
