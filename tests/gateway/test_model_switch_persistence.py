...
class TestIsIntentionalModelSwitch:
    ...
    default for a reason the system produced: a /model override, or the example gateway moving the
    session off the ``example/welcome`` alias the config still carries."""
