"""Tests for _setup_feishu() in panergos_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("panergos_cli.config.save_env_value", side_effect=mock_save), \
         patch("panergos_cli.config.get_env_value", side_effect=mock_get), \
         patch("panergos_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("panergos_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("panergos_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("panergos_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("panergos_cli.cli_output.print_header"), \
         patch("panergos_cli.cli_output.print_info"), \
         patch("panergos_cli.cli_output.print_success"), \
         patch("panergos_cli.cli_output.print_warning"), \
         patch("panergos_cli.cli_output.print_error"), \
