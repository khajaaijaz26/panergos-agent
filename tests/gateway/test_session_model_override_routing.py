...
provider, e.g. example instead of OpenAI Codex.
"""
...
""".lstrip(),
    ...
    def fake_resolve_runtime_provider(*, requested=None, explicit_base_url=None, explicit_api_key=None):
        if requested in {None, "", "openai-codex"}:
            ...
            raise AuthError("No Codex credentials stored. Run `panergos auth` to authenticate.")
    ...
    import panergos_cli.runtime_provider as runtime_provider
