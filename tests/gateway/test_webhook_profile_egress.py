...
``load_gateway_config`` against a temp PANERGOS_HOME — no patched predicates.
"""
import os
...
def profile_homes(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("panergos_cli.profiles._get_profiles_root", lambda: home / "profiles")
