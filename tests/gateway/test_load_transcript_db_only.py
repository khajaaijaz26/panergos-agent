...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.panergos/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at panergos_state import time, before pytest's PANERGOS_HOME monkeypatch
    fires — the autouse fixture's PANERGOS_HOME override doesn't help here.)
    """
