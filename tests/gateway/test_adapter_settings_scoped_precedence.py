...
def homes(tmp_path, monkeypatch):
    """(launch_home, secondary_home); PANERGOS_HOME points at the launch home, multiplex off on exit."""
...
def test_secondary_reads_own_yaml_and_never_the_launch_env(homes, monkeypatch):
    ...
    with _secondary_scope(secondary):
        ...
        monkeypatch.setenv("PANERGOS_TELEGRAM_DISABLE_FALLBACK_IPS", "true")
        built: list = []
