...
as the provider stream ends — concurrently with Panergos' consumer thread, which may not have
...
class RelayChatAccumulator:
    ...
    def observe(self, chunk: Any) -> None:
        ...
        choice = choices[0] if choices else None  # Panergos never requests n>1
    ...
    def finalize(self) -> dict[str, Any]:
        ...
        # "stop" also covers usage-only terminal frames with no finish_reason.
