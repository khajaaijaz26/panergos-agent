...
def _fire_pre_api_request_hook(
    ...
    try:
        from panergos_cli.lifecycle import has_hook, invoke_hook as _invoke_hook
...
def build_api_request(
    ...
    try:
        from panergos_cli.middleware import apply_llm_request_middleware
    ...
    if env_var_enabled("PANERGOS_DUMP_REQUESTS"):
