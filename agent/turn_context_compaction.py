...
def _codex_native_auto_compaction(agent: Any) -> bool:
    """Codex app-server threads are compacted by the codex agent itself; Panergos only
    initiates compaction in "panergos" mode."""
    return (
        # See #36801.
...
def _preflight_compression(
    ...
    if _preflight_deferred:
        ...
        logger.info(
            "Skipping Panergos preflight compression for codex app-server "
            "(mode=%s); Panergos will not start thread compaction here.",
