...
_DANGLING_NOTICES = (
    "[Orphan recovery: this tool may have executed before Panergos stopped; its effect is UNKNOWN. Inspect current state before retrying.]",
...
# (remote runtimes, exit 130), "[execution interrupted ...]" (code_execution_tool.py, exit -1).
