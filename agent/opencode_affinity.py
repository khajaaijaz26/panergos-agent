...
same way as the other conversation-affinity hints Panergos already sends
...
def opencode_session_headers(
    ...
    try:
        ...
        key = _cache_scope_from_session_id(
            ...
            # each routed independently of the conversation it belonged to (#70820). Mirrors the managed
