...
_SESSION_CWD: ContextVar = ContextVar("PANERGOS_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Panergos source tree, a
    legitimate workspace when developing Panergos; fallback-directory policy lives in the caller."""
