...
Pets live under ``get_panergos_home()/pets/<slug>/`` (profile-scoped; NOT petdex's
...
_HTTP_HEADERS = {"User-Agent": "panergos-agent-petdex"}
_THUMB_FRAME_W = 192
_THUMB_FRAME_H = 208
...
def pets_dir() -> Path:
    ...
    return _ensure_dir(get_panergos_home() / "pets")
