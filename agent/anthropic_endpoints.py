...
def _is_deepseek_anthropic_endpoint(base_url: str | None) -> bool:
    ...
    keep-unsigned policy used for Kimi's ``/coding`` endpoint. See panergos-agent#16748.
    """
...
def _requires_bearer_auth(base_url: str | None) -> bool:
    ...
    Foundry, Palantir Foundry's LLM proxy, and CommandCode. Palantir/CommandCode use
