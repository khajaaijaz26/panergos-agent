...
A host that runs a blocking command on a worker thread (Panergos Console) never sees
...
_ACTIVE_SCOPE: ContextVar[Optional["InterruptScope"]] = ContextVar("panergos_interrupt_scope", default=None)
