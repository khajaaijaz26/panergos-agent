...
class TurnFacadeMixin:
    ...
    def run_conversation(
        ...
        from panergos_cli.observability.relay_shared_metrics import finish_task_run, start_task_run
        ...
        try:
            ...
            if getattr(relay_turn, "relay_enabled", True):
                ...
                task_started = True
            # Ambient request tagging: every LLM call in this turn (loop, compression,
            ...
            # A host that owns this thread (Panergos Console) may cancel the turn cross-thread.
