/**
 * Panergos desktop plugin template. Save as:
 *   <panergos home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <panergos home> is ~/.panergos by default, or ~/.panergos/profiles/<name>
 * when running a named profile (`panergos -p <name>`). Run `panergos doctor` (or
 ...
 * Only these imports resolve: @panergos/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@panergos/plugin-sdk'
