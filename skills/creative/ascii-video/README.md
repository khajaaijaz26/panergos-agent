...
Built for [Panergos Agent](https://github.com/khajaaijaz26/panergos-agent). Usable in any coding agent. Canonical source lives here; synced to [`khajaaijaz26/panergos-agent/skills/creative/ascii-video`](https://github.com/khajaaijaz26/panergos-agent/tree/main/skills/creative/ascii-video) via PR.
