...
Common fixes:
- Brand names: spell phonetically ("nginx" -> "engine-x")
...
QUOTES = [
    ("This workflow turns a rough idea\ninto a polished visual story.", "Example speaker"),
]

# TTS text: flat, phonetically corrected for speech
QUOTES_TTS = [
    "This workflow turns a rough idea into a polished visual story.",
]
