...
class HandlerRegistry:
    ...
    def profile_scoped(self, fn):
        ...
        fn._panergos_profile_scoped = True
        return fn
    ...
    def install(self, server) -> None:
        ...
        for name, fn in self._pending:
            real = rebind(fn, g)
            if getattr(fn, "_panergos_profile_scoped", False):
