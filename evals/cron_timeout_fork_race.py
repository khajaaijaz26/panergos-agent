...
Run with the repository's Python and a disposable PANERGOS_HOME. No provider calls.
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="cron-owned-fork-") as root:
        os.environ["PANERGOS_HOME"] = root
        os.environ["PANERGOS_CRON_SCRIPT_TIMEOUT"] = "2"
