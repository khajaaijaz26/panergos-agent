...
os.environ.pop('PANERGOS_DELEGATED_CHILD_CONTEXT', None)
import pytest
...
spec = importlib.util.spec_from_file_location('http_fixture', fixture_root / 'tests/panergos_cli/test_kanban_pr_acceptance.py')
fixture = importlib.util.module_from_spec(spec)
spec.loader.exec_module(fixture)
patch = pytest.MonkeyPatch()
with tempfile.TemporaryDirectory(prefix='panergos-pr-live-') as home:
