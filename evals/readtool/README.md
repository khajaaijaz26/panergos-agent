...
benchmarked ten harnesses on hostile-file handling — and whose Panergos column
...
Every task runs the full Panergos agent (file + terminal + search toolsets)
...
Rules of engagement (from panergosbench discipline):
