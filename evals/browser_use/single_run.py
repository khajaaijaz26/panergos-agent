...
The run gets a throwaway PANERGOS_HOME so no local config leaks in, and the
...
# This reproducible battery uses one explicit provider and never reads account state.
