...
Run from a checkout with PANERGOS_HOME pointing to a disposable directory.
"""
import json
import os
...
os.environ["PANERGOS_MAX_TOKENS"] = "13"
...
from panergos_cli.moa_config import _normalize_preset
