...
def step(mode):
    from panergos_cli.main_dashboard import _install_hangup_protection, _finalize_update_output
    from panergos_cli.main import _run_logged_subprocess
