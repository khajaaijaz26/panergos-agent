...
batch (tracker: [#77056](https://github.com/khajaaijaz26/panergos-agent/issues/77056)).
...
- **Two arms, one variable.** `baseline` and `fixes` runs differ ONLY by
  ...
  Panergos home, same model, same tasks, same reps.
...
1. Create a dedicated Panergos home with credentials for the models under test:
   ...
   integration at it; no Panergos observability plugin needs to be enabled.
