...
os.environ["PANERGOS_HOME"] = tempfile.mkdtemp(prefix="panergos-e2e-55712-")
for m in [k for k in sys.modules if k.startswith(("panergos", "tools", "plugins"))]:
    del sys.modules[m]

import uvicorn  # noqa: E402

from panergos_cli import web_server  # noqa: E402
from panergos_cli.dashboard_auth import register_provider  # noqa: E402
from panergos_cli.dashboard_auth.base import RefreshExpiredError, Session  # noqa: E402
from tests.panergos_cli.conftest_dashboard_auth import StubAuthProvider  # noqa: E402
...
idp.calls = 0
ck = "panergos_session_at=expired-at; panergos_session_rt=cookie-stale; panergos_session_provider=stub"
with ThreadPoolExecutor(4) as pool:
