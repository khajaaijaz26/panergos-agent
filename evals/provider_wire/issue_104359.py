...
home = tempfile.mkdtemp(prefix="panergos-104359-")
os.environ.clear()
os.environ.update(
    HOME=home,
...
Path(os.environ["PANERGOS_HOME"], "config.yaml").write_text(yaml.safe_dump(config), encoding="utf-8")
...
db = SessionDB(Path(os.environ["PANERGOS_HOME"]) / "state.db")
