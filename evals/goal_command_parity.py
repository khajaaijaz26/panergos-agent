...
os.environ['PANERGOS_NIX_BUILD'] = '1'
sys.path.insert(0, str(root))
commands = importlib.import_module("panergos_cli.cli_commands_mixin")
GoalManager = importlib.import_module("panergos_cli.goals").GoalManager
