...
os.environ["PANERGOS_HOME"] = str(root / ".panergos")
from panergos_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    for name in ["alpha", "beta"]:
        home = root / ".panergos" / "profiles" / name
        ...
        p = subprocess.Popen(
            ...
            cwd=repo,
            env={**os.environ, "PANERGOS_HOME": str(home)},
    ...
    d = root / ".panergos/logs/update_receipts"
    ...
    home = root / ".panergos/profiles/beta"
