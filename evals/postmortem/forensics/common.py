"""Shared loaders for the post-mortem forensics: point at ANY Panergos ``state.db`` (a copy, never the live
...
the recomputed dollars match what THAT Panergos recorded, not an invoice.
...
class Run:
    ...
    def parser(cls, description: str = "") -> argparse.ArgumentParser:
        ...
        ap.add_argument("--db", required=True, help="path to a COPY of ~/.panergos/state.db")
