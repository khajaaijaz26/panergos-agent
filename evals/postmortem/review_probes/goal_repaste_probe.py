...
# Remove all inherited Panergos/config and credential env before real imports.
...
os.environ['PANERGOS_HOME'] = home.name
os.environ['NO_PROXY'] = '*'
os.environ['TZ'] = 'UTC'
...
from panergos_cli import cli_commands_mixin, goals
...
server._panergos_home = Path(home.name)
...
with patch('panergos_cli.goals.draft_contract', return_value=None), contextlib.redirect_stdout(io.StringIO()):
