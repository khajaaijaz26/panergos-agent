...
os.environ.setdefault("PANERGOS_HOME", os.path.expanduser("~/.panergos"))  # LIVE: real auxiliary judge calls (cents)
from panergos_cli import goals
goal = ("Simplify the panergos-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
