...
def run_case(root, output, name, behind, early=False, cancel=False):
    with tempfile.TemporaryDirectory(prefix="panergos_test_notice_") as home:
        ...
        from panergos_cli.banner import VERSION
        ...
        bootstrap = ("import panergos_cli.main as m; import panergos_cli.banner as b; "
        ...
        try:
            ...
            result = {"case": name, "ready": ready, "exited": exited,
                      ...
                      "loaded_worktree": str(root / "panergos_cli/banner.py") in text,
