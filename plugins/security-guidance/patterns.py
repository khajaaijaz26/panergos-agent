...
Panergos modifications: pattern data unchanged from upstream; the upstream RuleId
telemetry table (Claude Code PostToolUse metrics) is dropped — Panergos has no consumer.
Panergos-side wiring lives in __init__.py.
"""
