...
$PANERGOS_HOME/byterover/ (profile-scoped); ``memory.byterover.auto_extract: false`` disables curate hooks.
"""
...
def _get_brv_cwd() -> Path:
    ...
    return get_panergos_home() / "byterover"
...
def _brv_child_env(brv_path: str) -> Dict[str, str]:
    ...
    if is_multiplex_active():
        env = strip_launch_profile_env(env, get_panergos_home_override())
