...
# Author ids the bot-mode dispatcher assigns to other Panergos profiles (tools/bot_relay.py).
...
def assistant_peer_id_for(config: Any) -> str:
    ...
    return sanitize_peer_id(getattr(config, "ai_peer", None) or "panergos-assistant")
