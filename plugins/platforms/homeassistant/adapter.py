...
class HomeAssistantAdapter(BasePlatformAdapter):
    ...
    async def send(
        ...
        payload = {"title": "Panergos Agent", "message": content[:self.MAX_MESSAGE_LENGTH]}
...
# panergos_cli/gateway.py, and the _send_email dispatch in tools/send_message_tool.py. EMAIL_*
