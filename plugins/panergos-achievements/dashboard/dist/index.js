(function () {
  "use strict";
  // panergos-achievements dashboard plugin
  // Originally authored by @PCinkusz (MIT; see the bundled LICENSE).
  // Bundled into panergos-agent. Upstream repo remains the staging ground for new
  ...
  if (!SDK || !window.__PANERGOS_PLUGINS__) return;
  ...
  function api(path, options) {
    ...
    // BOTH dashboard modes: loopback (X-Panergos-Session-Token header) and
    // gated OAuth (panergos_session_at cookie via credentials:'include').
    // Hand-rolling fetch + reading window.__PANERGOS_SESSION_TOKEN__ directly
    ...
    const url = "/api/plugins/panergos-achievements" + path;
  ...
  async function buildShareImage(achievement) {
    ...
    ctx.fillText("PANERGOS AGENT  ·  github.com/khajaaijaz26/panergos-agent", 70, H - 40);
  ...
  function ShareDialog({ achievement, onClose }) {
    ...
    function download() {
      ...
      a.href = url;
      a.download = "panergos-achievement-" + (achievement.id || "badge") + ".png";
    ...
    function tweetText() {
      ...
      return tmpl + "\n\nPanergos Agent · https://github.com/khajaaijaz26/panergos-agent";
    }
    ...
    return React.createElement("div", { className: "ha-page ha-page-loading" },
      React.createElement("section", { className: "ha-hero ha-loading-hero" },
        React.createElement("div", null,
          ...
          React.createElement("h1", null, tx(t, "hero.title", "Panergos Achievements")),
          React.createElement("p", null, tx(t, "hero.scan_subtitle", "Scanning Panergos session history. First scan can take 5–10 seconds on large histories."))
        ),
      ...
      React.createElement("section", { className: "ha-guide ha-loading-guide" },
        React.createElement("div", null,
          ...
          React.createElement("p", null, tx(t, "guide.scan_status_body", "Panergos is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds."))
        ),
        React.createElement("div", null,
    ...
    return React.createElement("div", { className: "ha-page" },
      React.createElement("section", { className: "ha-hero" },
        React.createElement("div", null,
          React.createElement("div", { className: "ha-kicker" }, tx(t, "hero.kicker", "Agentic Gamerscore")),
          React.createElement("h1", null, tx(t, "hero.title", "Panergos Achievements")),
          React.createElement("p", null, tx(t, "hero.subtitle", "Collectible Panergos badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears."))
        ),
      ...
      React.createElement("section", { className: "ha-guide" },
        ...
        React.createElement("div", null,
          ...
          React.createElement("p", null, tx(t, "guide.secret_body", "Secrets hide their exact trigger. Once Panergos sees a related signal, the card becomes Discovered and shows its requirement."))
        )
      ),
  ...
  window.__PANERGOS_PLUGINS__.register("panergos-achievements", AchievementsPage);
})();
