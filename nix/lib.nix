      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via PANERGOS_BUNDLED_SKILLS /
            # PANERGOS_OPTIONAL_SKILLS (see panergos-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + PANERGOS_BUNDLED_LOCALES
            # / PANERGOS_OPTIONAL_MCPS, not via the wheel. Excluding them
