...
DEFAULT_UA = (
    "panergos-osint-investigation/0.2 "
    "(+https://github.com/khajaaijaz26/panergos-agent; "
    "set PANERGOS_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("PANERGOS_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
