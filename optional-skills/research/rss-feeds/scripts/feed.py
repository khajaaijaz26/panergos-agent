...
Standard library only, so it runs in any Panergos environment without an install
...
USER_AGENT = "panergos-agent/1.0 (rss-feeds skill; +https://github.com/khajaaijaz26/panergos-agent)"
TIMEOUT = 20
NS = {
