...
def _state_dir() -> Path:
    ...
    # Default: $PANERGOS_HOME/watcher-state/, falling back to ~/.panergos/watcher-state/.
    panergos_home = os.environ.get("PANERGOS_HOME") or str(Path.home() / ".panergos")
    return Path(panergos_home) / "watcher-state"
