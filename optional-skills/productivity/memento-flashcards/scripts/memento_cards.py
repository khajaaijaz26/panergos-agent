...
Data file: $PANERGOS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_PANERGOS_HOME = Path(os.environ.get("PANERGOS_HOME", Path.home() / ".panergos"))
DATA_DIR = _PANERGOS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
