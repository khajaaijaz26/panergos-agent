 ...
 *
 * Each entry is a key/value pair that lands in the packaged Panergos.app's
 ...
 * "Panergos wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Panergos wants to access Music" when Panergos never touches the Music
