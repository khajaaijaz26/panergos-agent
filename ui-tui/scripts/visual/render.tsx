 ...
 * across theme x background scenes to <tmpdir>/panergos-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@panergos/ink'
...
// The regenerated slate light_colors block from panergos_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/panergos-agent',
...
const setup = (bgHex: string) => {
  process.env.PANERGOS_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
