...
await build({
  ...
  // Skip the prebuilt @panergos/ink bundle and inline the source instead:
  ...
  alias: { '@panergos/ink': resolve(root, 'packages/panergos-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The panergos_cli launcher
