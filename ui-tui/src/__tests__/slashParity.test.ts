...
import { parseSlashCommand } from '@panergos/shared/slash'
  ...
  try {
    const names = JSON.parse(
      execFileSync(
        ...
        [
          '-c',
          'import json; from panergos_cli.commands import COMMAND_REGISTRY; print(json.dumps([c.name for c in COMMAND_REGISTRY]))'
        ],
