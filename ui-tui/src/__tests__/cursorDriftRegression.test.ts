 ...
 *
 * Symptom: in `panergos --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@panergos/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using panergos --tui and as i type multiline my caret at the end will often ' +
