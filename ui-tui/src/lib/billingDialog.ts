import type { BillingBlock } from '@panergos/shared/billing'
 ...
 * confirm button opens the provider's billing page (or `/model` to switch when
 * no URL is available). Pure + exported so
