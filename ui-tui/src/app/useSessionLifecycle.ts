...
import type { ScrollBoxHandle } from '@panergos/ink'
import { evictInkCaches } from '@panergos/ink'
import type { InflightTurn, SessionResumeResult, Usage } from '@panergos/shared/gateway-events'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.PANERGOS_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
