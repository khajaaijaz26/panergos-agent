...
import { Box, type ScrollBoxHandle, stringWidth, Text } from '@panergos/ink'
import { compactNumber } from '@panergos/shared/format'
...
export function StatusRule({
  ...
  // Dev-only readout (PANERGOS_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (PANERGOS_DEV_CREDITS), lowest priority,
