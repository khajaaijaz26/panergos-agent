...
export type { BillingBlock } from '@panergos/shared/billing'
...
export interface ConfigDisplayConfig {
  ...
  // `normalizeIndicatorStyle` falls back to 'relay' for those — but the
