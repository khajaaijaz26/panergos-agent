"""``panergos journey`` — what Panergos has learned, on a timeline."""
...
def _primary_hex() -> str:
    ...
    try:
        ...
        return skin.get_color("ui_primary", "") or skin.get_color("banner_title", "#FF6B5E")
    except Exception:
        return "#FF6B5E"
...
def _cmd_show(args: argparse.Namespace) -> int:
    ...
    if not payload.get("nodes"):
        console.print(
            "[grey62]No learning yet — use Panergos a while and your learned skills and "
...
if __name__ == "__main__":
    _p = argparse.ArgumentParser(prog="panergos journey")
    register_cli(_p)
    _a = _p.parse_args()
    sys.exit(_a.func(_a))
