...
class CLIStatusBarMixin:
    ...
    def _get_status_bar_snapshot(self) -> Dict[str, Any]:
        ...
        try:
            from panergos_cli.focus_view import focus_statusbar_segment
        ...
        try:
            ...
            if _fields is not None and "git_branch" in _fields:
                from panergos_cli.status_bar_git import current_git_branch
    ...
    def _pet_resolve_config(self) -> None:
        """(Re)resolve the active pet from config so ``/pet`` / ``panergos pets`` changes apply
    ...
    def set_voice_record_key_cache(self, raw_key: object) -> None:
        ...
        try:
            from panergos_cli.voice import format_voice_record_key_for_status
    ...
    def _build_status_bar_text(self, width: Optional[int] = None) -> str:
        ...
        try:
            ...
            return f"→ {self.model if getattr(self, 'model', None) else 'Panergos'}"
    ...
    def _get_status_bar_fragments(self):
        ...
        try:
            ...
            # Battery is the first element when enabled: prepend ahead of the static brand marker.
            battery_label = snapshot.get("battery_label") or ""
