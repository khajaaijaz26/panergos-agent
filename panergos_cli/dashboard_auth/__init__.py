...
session from a registered ``DashboardAuthProvider``; third parties register theirs via the
plugin hook ``ctx.register_dashboard_auth_provider``)."""
...
from panergos_cli.dashboard_auth.registry import (
