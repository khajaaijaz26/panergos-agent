...
``@panergos/ui`` design system; fonts load from the SPA's ``/fonts/``
...
<body>
<main>
  <div class="brand">Panergos<span class="dot"></span>Agent</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Panergos Agent dashboard.</p>
...
See the <a href="https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
