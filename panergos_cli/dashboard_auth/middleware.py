...
from panergos_cli.dashboard_auth import list_session_providers
from panergos_cli.dashboard_auth.audit import AuditEvent, audit_log
from panergos_cli.dashboard_auth.base import ProviderError
...
from panergos_cli.dashboard_auth.prefix import prefix_from_request
from panergos_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
from panergos_cli.dashboard_auth.refresh_singleflight import refresh_session_coalesced
from panergos_cli.dashboard_auth.request_utils import (
...
_GATE_PUBLIC_PREFIXES: tuple[str, ...] = (
    ...
    "/assets/", "/favicon.ico", "/panergos-mark.svg", "/ds-assets/", "/fonts/",
    "/fonts-terminal/")
...
def _safe_next_target(request: Request) -> str:
    ...
    SPA's ``sessionStorage["panergos.lastLocation"]``."""
...
_PLUGIN_COMPAT_LAZY = {
    'DashboardAuthProvider': ('panergos_cli.dashboard_auth.base', 'DashboardAuthProvider'),
}
