"""Relay subscriber for the persisted Panergos shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Panergos counters from Relay lifecycle events."""

    def __init__(
        self,
        store: SharedMetricsStore,
        panergos_version: str,
        *,
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Panergos shared metric: %s", metric_name, exc_info=True
                )
