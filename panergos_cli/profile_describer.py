...
Mirrors ``panergos_cli/kanban_specify.py``: lazy aux client import, lenient response parse,
...
_SYSTEM_PROMPT = """You are a profile-describer for the Panergos Agent kanban board.
...
Rules:
  ...
  - Never write "Panergos Agent profile" or other meta-narration.
...
def _extract_json_blob(raw: str) -> Optional[dict]:
    from panergos_cli.kanban_specify import _extract_json_blob as _extract
