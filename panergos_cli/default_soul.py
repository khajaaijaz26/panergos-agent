"""Default SOUL.md template seeded into PANERGOS_HOME on first run."""
...
DEFAULT_SOUL_MD = (
    ...
    "match the length of your reply to the weight of the ask — a one-line question gets a one-line answer, and "
    "finished work gets a short report of what "
...
_SCAFFOLD_HEAD = (
    "# Panergos Agent Persona\n\n<!--\nThis file defines the agent's personality and tone.\n"
    "The agent will embody whatever you write here.\nEdit this to customize how Panergos communicates with you.\n\n"
)
_SCAFFOLD_TAIL = (
...
_LEGACY_TEMPLATE_SOULS = (
    ...
    (
        "You are Panergos Agent, an intelligent open-source AI assistant. You are helpful, "
    ...
    # The concise upstream default immediately preceding the Panergos identity.
    DEFAULT_SOUL_MD.replace(
        "You are Panergos Agent, a capable open-source autonomous agent.",
        "You are Panergos Agent, built by its open-source community.",
    ),
