"""Skills configuration for Panergos Agent. `panergos skills` enters this module."""
from typing import List, Optional, Set

from panergos_cli.config import cfg_get, load_config, save_config
from panergos_cli.colors import Colors, color
from panergos_cli.platforms import PLATFORMS as _PLATFORMS
...
def save_disabled_skills(config: dict, disabled: Set[str], platform: Optional[str] = None):
    """Persist disabled skill names to config; essential skills (e.g. ``panergos-agent``) are
...
def skills_command(args=None):
    """Entry point for `panergos skills`."""
    from panergos_cli.curses_ui import curses_checklist
    config = load_config()
