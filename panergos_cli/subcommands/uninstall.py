"""``panergos uninstall`` subcommand parser."""
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall", help="Uninstall Panergos Agent",
        description="Remove Panergos Agent from your system. Can keep configs/data for reinstall.")
