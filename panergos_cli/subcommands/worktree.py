"""``panergos worktree`` subcommand parser."""
...
def build_worktree_parser(subparsers) -> None:
    ...
    worktree_parser = subparsers.add_parser(
        ...
        description="Attended reclaim for the .worktrees/ directory panergos -w sessions "
            "accumulate. Never deletes uncommitted tracked changes, unique "
            "unpushed commits, or in-use trees; untracked-only scratch is "
            "archived to ~/.panergos/archive/worktree-prune/ before removal. See: "
            "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/cli#worktree-cleanup")
