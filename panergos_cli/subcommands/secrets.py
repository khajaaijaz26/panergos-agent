"""``panergos secrets`` subcommand parser."""
...
def build_secrets_parser(subparsers) -> None:
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description="Pull API keys from an external secret manager at process startup "
            "instead of storing them in ~/.panergos/.env.  Supports Bitwarden "
            "Secrets Manager and 1Password.  See: "
            "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/secrets/")
    ...
    from panergos_cli import secrets_cli as _secrets_cli
    from panergos_cli import onepassword_secrets_cli as _op_secrets_cli
