"""``panergos profile`` subcommand parser."""
...
def build_profile_parser(subparsers, *, cmd_profile: Callable) -> None:
    ...
    profile_parser = subparsers.add_parser(
        "profile", help="Manage profiles — multiple isolated Panergos instances")
    ...
    profile_create.add_argument(
        ...
        help="Create an empty profile with no bundled skills (opts out of `panergos update` skill sync)",
    )
    profile_create.add_argument(
        ...
        help="One- or two-sentence description of what this profile is good at. "
             ...
             "of profile name alone. Skip and add later via `panergos profile describe`.")
    ...
    profile_export.add_argument(
        ...
        help="Output file (default: a managed profile-exports/<name>-<timestamp>.tar.gz "
             "under the default Panergos home)")
    ...
    profile_install = profile_subparsers.add_parser(
        ...
        description="Install a Panergos profile distribution. SOURCE can be a git URL "
