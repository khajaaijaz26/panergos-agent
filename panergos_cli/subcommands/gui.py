"""``panergos gui`` subcommand parser."""
...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Panergos Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any Panergos CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--panergos-root",
        help="Override the Panergos source root used by Desktop (sets PANERGOS_DESKTOP_PANERGOS_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets PANERGOS_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Panergos Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Panergos Local Signing)",
    )
