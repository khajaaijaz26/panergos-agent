...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    "telegram": {
        "name": "Telegram", "description": "Run Panergos from Telegram DMs, groups, and topics.",
        "docs_url": "https://core.telegram.org/bots/features#botfather",
        "env_vars": ("TELEGRAM_BOT_TOKEN", "TELEGRAM_ALLOWED_USERS", "TELEGRAM_PROXY"),
        "required_env": ("TELEGRAM_BOT_TOKEN",),
    },
    "discord": {
        "name": "Discord", "description": "Connect Panergos to Discord DMs, channels, and threads.",
    ...
    "slack": {
        "name": "Slack",
        "description": "Use Panergos from Slack via Socket Mode. Add allowed Slack member IDs so connected bots can respond.",
    ...
    "mattermost": {
        "name": "Mattermost",
        "description": "Connect Panergos to Mattermost channels and direct messages.",
        "docs_url": "https://mattermost.com/deploy/",
        "env_vars": ("MATTERMOST_URL", "MATTERMOST_TOKEN", "MATTERMOST_ALLOWED_USERS"),
        "required_env": ("MATTERMOST_URL", "MATTERMOST_TOKEN"),
    },
    "matrix": {
        "name": "Matrix", "description": "Use Panergos in Matrix rooms and direct messages.",
    ...
    "whatsapp": {
        "name": "WhatsApp",
        "description": "Use Panergos through the bundled WhatsApp bridge with QR-based auth.",
    ...
    "homeassistant": {
        "name": "Home Assistant",
        "description": "Control your smart home from Panergos via Home Assistant.",
        "docs_url": "https://www.home-assistant.io/docs/authentication/",
        "env_vars": ("HASS_URL", "HASS_TOKEN"), "required_env": ("HASS_URL", "HASS_TOKEN"),
    },
    "email": {
        "name": "Email", "description": "Talk to Panergos through an IMAP/SMTP mailbox.",
        "docs_url": "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/messaging/",
    ...
    "feishu": {
        "name": "Feishu / Lark", "description": "Use Panergos inside Feishu / Lark.",
    ...
    "weixin": {
        ...
        "docs_url": "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/messaging/weixin/",
        "env_vars": ("WEIXIN_ACCOUNT_ID", "WEIXIN_TOKEN", "WEIXIN_BASE_URL"),
        "required_env": ("WEIXIN_ACCOUNT_ID", "WEIXIN_TOKEN"),
    },
    "bluebubbles": {
        "name": "BlueBubbles (iMessage)",
        "description": "Use Panergos through iMessage via a BlueBubbles server.",
    ...
    "qqbot": {
        "name": "QQ Bot", "description": "Connect Panergos to a QQ Bot from the QQ Open Platform.",
    ...
    "teams": {
        "description": "Connect Panergos to Microsoft Teams chats via the Bot Framework.",
        "docs_url": "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/messaging/teams",
    },
    ...
    "irc": {
        "description": "Relay messages between an IRC channel (or DMs) and Panergos.",
        "docs_url": "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/messaging/irc",
    },
    "line": {
        "description": "Use Panergos from LINE via the LINE Messaging API webhook.",
        "docs_url": "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/messaging/line",
    },
    "ntfy": {
        "description": "Chat with Panergos over ntfy push topics (ntfy.sh or self-hosted).",
        "docs_url": "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/messaging/ntfy",
    },
    "photon": {
        "description": "Use Panergos through iMessage via Photon's managed Spectrum platform.",
        "docs_url": "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/messaging/photon",
    },
    "raft": {
        "description": "Join a Raft workspace as an external agent.",
        "docs_url": "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/messaging/raft",
    },
    "simplex": {
        "description": "Talk to Panergos over SimpleX Chat via a local simplex-chat daemon.",
        "docs_url": "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/messaging/simplex",
    },
    "yuanbao": {
        "name": "Yuanbao (元宝)", "description": "Connect Panergos to Tencent Yuanbao.", "docs_url": "",
        "required_env": (),
    },
    "api_server": {
        "name": "API server",
        "description": "Expose Panergos as an OpenAI-compatible HTTP API for tools like Open WebUI.",
        "docs_url": "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/messaging/",
        "env_vars": (
    ...
    "webhook": {
        ...
        "docs_url": "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/messaging/webhooks/",
    ...
    "msgraph_webhook": {
        ...
        "docs_url": "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/messaging/msgraph-webhook",
        "required_env": (),
    },
    "whatsapp_cloud": {
        "name": "WhatsApp Cloud API",
        "description": "Use Panergos via Meta's hosted WhatsApp Cloud API (no local bridge).",
        "docs_url": "https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/messaging/whatsapp-cloud",
    },
    "relay": {
        "name": "Relay (experimental)",
        "description": "Generic relay adapter fronted by the bundled relay connector.",
...
def _platform_env_prefixes(platform_id: str) -> tuple[str, ...]:
    ...
    from panergos_cli.profile_channels import platform_env_prefixes
...
def _whatsapp_session_path() -> Path:
    from panergos_constants import get_panergos_dir
    return get_panergos_dir("platforms/whatsapp/session", "whatsapp/session")
...
_TELEGRAM_ONBOARDING_USER_AGENT = f"PanergosDashboard/{__version__}"
...
def _telegram_onboarding_base_url() -> str:
    return os.getenv("TELEGRAM_ONBOARDING_URL", "").strip().rstrip("/")
...
def _telegram_onboarding_request_sync(
    ...
    if not base_url:
        raise HTTPException(status_code=503, detail="Telegram setup service is not configured.")
    ...
    try:
        with httpx.Client(timeout=httpx.Timeout(10.0)) as client:
            response = client.request(method, f"{base_url}{path}", headers=headers, **request_kwargs)
