"""Non-interactive HTTPS credentials for Panergos's internal git clones (private plugin/MCP/profile repos).
...
repo the user can already clone from their shell fails inside ``panergos plugins install`` with
