...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Panergos to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Panergos needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Panergos gateway in another terminal:",
        "         panergos gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://khajaaijaz26.github.io/panergos-agent/docs/user-guide/",
