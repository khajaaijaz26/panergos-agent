...
:mod:`panergos_cli.commands` (which re-exports both classes) so the registry module stays
...
from panergos_cli.commands import COMMANDS, SUBCOMMANDS
...
def _skin_completions(sub_text: str, sub_lower: str):
    ...
    from panergos_cli.skin_engine import list_skins
...
def _personality_completions(sub_text: str, sub_lower: str):
    ...
    from panergos_cli.personality import describe_personality
