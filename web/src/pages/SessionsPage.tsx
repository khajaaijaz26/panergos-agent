...
import { ListItem } from "@panergos/ui/ui/components/list-item";
import { Segmented } from "@panergos/ui/ui/components/segmented";
...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    panergos_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__panergos_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id, rowProfile(id)), {
          ...
          headers: {
            "X-Panergos-Session-Token":
              (window as unknown as { __PANERGOS_SESSION_TOKEN__?: string })
                .__PANERGOS_SESSION_TOKEN__ ?? "",
          },
        });
