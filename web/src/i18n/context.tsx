import { applyDocumentLocale, LOCALE_ENDONYMS } from "@panergos/shared/i18n";
...
// Display metadata for the language picker — endonyms from @panergos/shared so the
...
const STORAGE_KEY = "panergos-locale";
