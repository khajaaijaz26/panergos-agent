...
export interface Translations {
  ...
  status: {
    ...
    updatePanergosConfirmMessage?: string;
    updatePanergosConfirmNow?: string;
    updatePanergosConfirmTitle?: string;
    updatingPanergos: string;
  ...
  // ── Achievements plugin (plugins/panergos-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
