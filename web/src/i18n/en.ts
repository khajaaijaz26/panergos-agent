...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updatePanergos: "Update Panergos Agent",
    updatePanergosConfirmMessage:
      "This runs panergos update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updatePanergosConfirmNow: "Update now",
    updatePanergosConfirmTitle: "Update Panergos Agent?",
    updatingPanergos: "Updating Panergos Agent…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Panergos plugins (`panergos plugins` parity).",
    ...
    catalogEmptyDocsLink: "Learn about Panergos plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.panergos/skills/",
  ...
  config: {
    configPath: "~/.panergos/config.yaml",
    filters: "Filters",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Panergos Agent doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Panergos Achievements",
      subtitle:
        "Collectible Panergos badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Panergos session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Panergos sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Panergos is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
