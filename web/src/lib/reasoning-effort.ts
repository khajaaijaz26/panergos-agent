 ...
 *
 * Values come from @panergos/shared (panergos_constants.VALID_REASONING_EFFORTS
 * plus `none`, thinking-off). An empty/unset config value means the Panergos
 * default.
 */
 ...
 *  option. Empty/unknown → `medium` (Panergos' default when unset). */
