 ...
 *
 * Plugins call window.__PANERGOS_PLUGINS__.register(name, Component)
...
} from "@panergos/ui/ui/components/dialog";
...
import { Card, CardHeader, CardTitle, CardContent } from "@panergos/ui/ui/components/card";
import { Input } from "@panergos/ui/ui/components/input";
import { Label } from "@panergos/ui/ui/components/label";
import { Separator } from "@panergos/ui/ui/components/separator";
import { Tabs, TabsList, TabsTrigger } from "@panergos/ui/ui/components/tabs";
 ...
 * Exposed at runtime as ``window.__PANERGOS_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__PANERGOS_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__PANERGOS_PLUGIN_SDK__ = {
    ...
    // window.__PANERGOS_SESSION_TOKEN__ directly.
    authedFetch,
    ...
    // UI components — Panergos UI where available, shadcn/ui primitives elsewhere.
    components: {
      Card,
      CardHeader,
      CardTitle,
