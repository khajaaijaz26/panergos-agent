...
def main() -> None:
    ...
    panergos_home = Path(tempfile.mkdtemp(prefix="panergos-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "panergos-gateway-smoke",
    ...
    print(json.dumps({"panergos_home": str(panergos_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
