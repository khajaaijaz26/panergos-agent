...
content = login). File additions never merge-conflict.
...
"present" and exits 0. If the email maps to a DIFFERENT login, refuses with
exit 1 so a typo cannot silently reassign someone's commits.
"""
