#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Panergos logs.
...
With no LOGFILE, reads ``$PANERGOS_HOME/logs/agent.log`` (default ~/.panergos).
...
def default_log() -> Path:
    home = os.environ.get("PANERGOS_HOME") or str(Path.home() / ".panergos")
