...
# `require_mention: true` without custom aliases uses Panergos wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?panergos\s+agent\b[,:\-]?", r"(?<![\w@])@?panergos\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Panergos defaults)."""
