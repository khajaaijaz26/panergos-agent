...
plugins should use :func:`canonical_whatsapp_identifier` to line up with Panergos' session keys.
"""
...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    if not normalized:
        return set()
    session_dir = get_panergos_dir("platforms/whatsapp/session", "whatsapp/session")
