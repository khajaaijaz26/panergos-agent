...
def _store_path() -> str:
    from panergos_constants import get_panergos_home  # honors the active profile override
    return os.path.join(str(get_panergos_home()), "state", "rich_sent_index.json")
