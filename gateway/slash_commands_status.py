"""Read-only gateway introspection commands: /status, /context, /usage, /agents, and /insights.
...
from panergos_cli.status_report import build_status_fields
...
class GatewayStatusCommandsMixin:
    ...
    async def _handle_insights_command(self, event: MessageEvent) -> str:
        ...
        try:
            ...
            # Not a bare hop: ``SessionDB()`` resolves ``get_panergos_home()`` at call time, a
