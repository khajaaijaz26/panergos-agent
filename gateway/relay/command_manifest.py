...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Panergos session"),
        ...
        _cmd("status", "Show Panergos session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Panergos agent"),
        ...
        _cmd("update", "Update Panergos Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Panergos gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Panergos session in it",
