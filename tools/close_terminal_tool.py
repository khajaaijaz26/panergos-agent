"""Close a read-only agent terminal tab in the Panergos desktop GUI WITHOUT killing
...
CLOSE_TERMINAL_SCHEMA = {
    ...
    "description": (
        ...
        "the panergos desktop GUI (the tabs mirroring terminal(background=true) runs). "
