...
def render_command_template(command_template: str, placeholders: Dict[str, str]) -> str:
    ...
    def replace_match(match: re.Match[str]) -> str:
        ...
        token = f"__PANERGOS_CMD_PLACEHOLDER_{len(replacements)}__"
...
def run_command_provider(
    ...
    provider survives, a silently stalled one is killed. Child env is scrubbed of Panergos secrets
    ...
    scrubbed = panergos_subprocess_env(inherit_credentials=False)
