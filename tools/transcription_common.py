...
LOCAL_STT_COMMAND_ENV = "PANERGOS_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "PANERGOS_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via panergos_cli.models.deepinfra_base_url (shared).
