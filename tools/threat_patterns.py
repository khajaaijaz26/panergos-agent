...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'unset\s+\w*(?:CLAUDE|CODEX|PANERGOS|AGENT|OPENAI|ANTHROPIC)\w*', "env_var_unset_agent", "context"),
    ...
    (r'\$HOME/\.panergos/\.env|\~/\.panergos/\.env', "panergos_env", "strict"),
    (rf'{_MODIFY}(?:AGENTS\.md|CLAUDE\.md|\.cursorrules|\.clinerules)', "agent_config_mod", "strict"),
    (rf'{_MODIFY}\.panergos/(config\.yaml|SOUL\.md)', "panergos_config_mod", "strict"),
