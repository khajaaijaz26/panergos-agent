...
DIALOG_BRIDGE_HOST = "panergos-dialog-bridge.invalid"
...
(() => {
  if (window.__panergosDialogBridgeInstalled) return;
  window.__panergosDialogBridgeInstalled = true;
  const ENDPOINT = "http://panergos-dialog-bridge.invalid/";
