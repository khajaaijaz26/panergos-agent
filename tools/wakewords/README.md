...
`hey_panergos.onnx` / `hey_panergos.tflite` — the on-device "Hey Panergos" hotword
...
- **Label:** the model registers as `hey_panergos` (matches the filename).
