...
started by `panergos mcp login/reauth`, never a background reconnect.
"""
...
async def login_device(name, server_url, oauth_config):
    ...
    from tools.mcp_oauth_manager import PanergosMCPOAuthProvider, get_manager
    ...
    provider = PanergosMCPOAuthProvider(server_url=server_url, server_name=name, storage=storage,
