...
# containing `cat ~/.panergos/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `panergos-agent-dev` skill contains a security postmortem mentioning `cat ~/.panergos/.env`, which tripped
