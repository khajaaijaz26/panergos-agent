...
from panergos_state_common import _BOUNDARY_END_REASONS

# Hidden from browsing/searching — integrations (PANERGOS_SESSION_SOURCE=tool), delegate
...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Recall past conversations: search or read old panergos sessions (FTS5), or "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another panergos profile's database "
