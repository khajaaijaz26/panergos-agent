...
_HOMEBREW_CI_POLLER_HINT = (
    ...
    'and/or `gh pr checks | jq`. That shape has burned us repeatedly in panergos-agent dev work '
    ...
    "skill_view(name='github/panergos-agent-dev', file_path='references/green-ci-policy.md') for "
...
_ASYNC_UNSUPPORTED_NOTE = (
    ...
    'an async completion after the turn ends (a one-shot runner such as `panergos -z`, a cron '
...
# proc_session attribute -> PANERGOS_SESSION_* env var carrying it.
_ROUTING_FIELDS = (
    ("watcher_chat_id", "PANERGOS_SESSION_CHAT_ID"),
    ("watcher_user_id", "PANERGOS_SESSION_USER_ID"),
    ("watcher_user_name", "PANERGOS_SESSION_USER_NAME"),
    ("watcher_thread_id", "PANERGOS_SESSION_THREAD_ID"),
    ("watcher_message_id", "PANERGOS_SESSION_MESSAGE_ID"),
    ...
    ("parent_session_id", "PANERGOS_SESSION_ID"),
)
