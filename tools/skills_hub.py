...
Used by panergos_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "PANERGOS_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"PANERGOS_HOME": _panergos_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'PANERGOS_INDEX_TTL': ('tools.skills_hub_search', 'PANERGOS_INDEX_TTL'),
    'PANERGOS_INDEX_URL': ('tools.skills_hub_search', 'PANERGOS_INDEX_URL'),
    'PanergosIndexSource': ('tools.skills_hub_official', 'PanergosIndexSource'),
