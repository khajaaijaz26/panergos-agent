...
const config: Config = {
  ...
  organizationName: 'khajaaijaz26',
  projectName: 'panergos-agent',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-panergos-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/khajaaijaz26/panergos-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    metadata: [
      {name: 'theme-color', content: '#120B1F'},
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'GitHub Issues', href: 'https://github.com/khajaaijaz26/panergos-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Source installation', to: '/getting-started/installation' },
            { label: 'GitHub', href: 'https://github.com/khajaaijaz26/panergos-agent' },
          ],
        },
      ],
      copyright: `Panergos Agent · Open source · ${new Date().getFullYear()}`,
    },
    prism: {
