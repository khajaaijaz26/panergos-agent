---
sidebar_position: 8
title: "Use Voice Mode with Panergos"
description: "A practical guide to setting up and using Panergos voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Panergos
...
:::tip
Voice mode needs both a configured model and TTS provider; set them up with `panergos model --quick` and `panergos tools`.
:::
...
- you want Panergos sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Panergos.
...
## Step 1: make sure normal Panergos works first
...
Panergos supports both local and cloud speech stacks.
...
4. Panergos transcribes and responds
...
- asking Panergos to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Panergos loop.

## Tuning CLI behavior

### Silence threshold

If Panergos starts/stops too aggressively, tune:
...
Panergos stays a normal chat bot, but can speak replies.
...
- you want Panergos to function like a portable research or ops assistant
...
Panergos joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Panergos detects speech boundaries
- transcripts are posted in the associated text channel
- Panergos responds in text and audio
...
1. get text Panergos working
2. run `panergos setup tts` to enable voice support
