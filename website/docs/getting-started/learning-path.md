...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Panergos Agent documentation based on your experience level and goals.'
---

# Learning Path

Panergos Agent can do a lot — CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed Panergos Agent yet, begin with the [Installation guide](/getting-started/installation) and then run through the [Quickstart](/getting-started/quickstart). Everything below assumes you have a working installation.
:::

:::tip First-time provider setup
First-time users should run `panergos model --quick` to connect a ready local runtime or cloud model with minimal setup.
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Panergos Agent can do.
...
Use Panergos Agent as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. Panergos Agent can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Panergos Agent as a bot on your favorite messaging platform.
...
7. [Use Voice Mode with Panergos](/guides/use-voice-mode-with-panergos)
...
:::tip
Cron jobs let Panergos Agent run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::
...
Extend Panergos Agent with your own tools and reusable skill packages.

1. [Plugins](/user-guide/features/plugins)
2. [Build a Panergos Plugin](/developer-guide/plugins)
...
page is for built-in Panergos core development, not the usual user/custom-tool path.
:::
...
:::tip
RL training works best when you already understand the basics of how Panergos Agent handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate Panergos Agent into your own Python applications programmatically.
...
| **Code Execution** | Run Python scripts that call Panergos tools programmatically | [Code Execution](/user-guide/features/code-execution) |
