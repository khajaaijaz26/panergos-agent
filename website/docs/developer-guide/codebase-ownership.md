...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `panergos_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `panergos_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Panergos Plugin](plugins/index.md) |
...
| Session storage | `panergos_state.py`, `panergos_state_*.py` | [Session Storage](session-storage.md) |
