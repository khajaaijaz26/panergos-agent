...
| [`panergos-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-panergos-agent) | Operate and extend Panergos Agent. | `autonomous-ai-agents/panergos-agent` |
...
| [`organization-workflows`](/user-guide/skills/bundled/productivity/productivity-organization-workflows) | Coordinate reviewable work across roles and departments. | `productivity/organization-workflows` |
...
| [`panergos-agent-skill-authoring`](/user-guide/skills/bundled/software-development/software-development-panergos-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/panergos-agent-skill-authoring` |
| [`inspecting-panergos-desktop-dom`](/user-guide/skills/bundled/software-development/software-development-inspecting-panergos-desktop-dom) | Read the live Panergos desktop DOM/CSS over CDP. | `software-development/inspecting-panergos-desktop-dom` |
