...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/autonomous-ai-agents/dynamic-workflow` |
| Path | `optional-skills/autonomous-ai-agents/dynamic-workflow` |
| Version | `2.0.0` |
| Author | Teknium + Panergos Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `orchestration`, `fan-out`, `subagents`, `delegation`, `verification`, `migration`, `audit`, `research`, `campaign` |
| Related skills | [`panergos-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-panergos-agent), [`simplify-code`](/user-guide/skills/bundled/software-development/software-development-simplify-code) |
...
for serial chains. For a refactor or fix campaign on panergos-agent itself, load
`panergos-agent` (the dev workflow) alongside; this skill owns the fan-out shape.
...
10. Live QA is its own wave: one squad per surface, isolated `PANERGOS_HOME`,
