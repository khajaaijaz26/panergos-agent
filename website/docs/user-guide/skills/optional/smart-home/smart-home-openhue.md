...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/smart-home/openhue` |
...
- Bridge must be on the same local network as the machine running Panergos
