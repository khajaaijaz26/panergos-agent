...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Panergos Agent |
| License | MIT |
...
The script reads `${PANERGOS_HOME:-~/.panergos}/.env` for two optional defaults:
...
Helper script: `~/.panergos/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.panergos/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${PANERGOS_HOME:-~/.panergos}/.env`.
...
```bash
python ~/.panergos/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.panergos/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
