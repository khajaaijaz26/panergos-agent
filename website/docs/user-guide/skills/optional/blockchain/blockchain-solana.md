...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Panergos Agent |
| License | MIT |
...
Helper script path: ~/.panergos/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.panergos/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.panergos/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.panergos/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.panergos/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.panergos/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.panergos/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
