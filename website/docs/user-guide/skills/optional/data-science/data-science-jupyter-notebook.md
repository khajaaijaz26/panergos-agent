...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing panergos tool access (web_search, file ops). Stateless. |
