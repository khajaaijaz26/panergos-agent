...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/health/neuroskill-bci` |
...
Connect Panergos to a running [NeuroSkill](https://neuroskill.com/) instance to read
