...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Panergos Agent |
| License | MIT |
...
```
SCRIPT=~/.panergos/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.panergos/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
