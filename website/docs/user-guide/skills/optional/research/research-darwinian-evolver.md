...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Panergos Agent |
| License | MIT |
...
import upstream classes into Panergos itself.
...
```bash
mkdir -p ~/.panergos/cache/darwinian-evolver && cd ~/.panergos/cache/darwinian-evolver
...
```bash
cd ~/.panergos/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.panergos/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.panergos/skills/research/darwinian-evolver
DE_DIR=~/.panergos/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Panergos core.
   Custom driver scripts under `~/.panergos/skills/...` are user-side and fine.
