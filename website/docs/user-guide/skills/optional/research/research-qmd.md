...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`panergos-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-panergos-agent), [`arxiv`](/user-guide/skills/bundled/research/research-arxiv) |
...
Panergos Agent via the native MCP client. This is the preferred
...
Then configure Panergos Agent to connect via HTTP:
