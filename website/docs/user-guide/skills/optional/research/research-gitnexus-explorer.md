...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/research/gitnexus-explorer` |
...
| Related skills | [`panergos-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-panergos-agent), [`codebase-inspection`](/user-guide/skills/bundled/software-development/software-development-codebase-inspection) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  panergos-agent users don't need.
