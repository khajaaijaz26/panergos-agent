...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Panergos Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $PANERGOS_OSINT_CACHE/icij/ (default: ~/.cache/panergos-osint/icij/).
...
# Set PANERGOS_OSINT_UA=your-app/1.0 (your@email) to identify yourself
