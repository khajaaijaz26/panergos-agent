...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/research/blogwatcher` |
...
## Working with Panergos tools (read this first)

`blogwatcher-cli` is the feed database; Panergos tools do the automation around it:
