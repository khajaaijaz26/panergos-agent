...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/creative/impeccable` |
...
> ships and verifies a Panergos-native skill bundle under `.panergos/skills/`.
> `panergos skills install impeccable` pulls the current bundle live from that
