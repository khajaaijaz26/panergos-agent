...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/creative/ascii-art` |
| Path | `optional-skills/creative/ascii-art` |
| Version | `4.0.0` |
| Author | 0xbyt4, Panergos Agent |
| License | MIT |
...
```bash
python -m pyfiglet "PANERGOS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=PANERGOS&font=Slant" | boxes -d stone
```
