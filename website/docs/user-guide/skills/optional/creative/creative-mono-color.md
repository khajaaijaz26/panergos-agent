...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/creative/mono-color` |
| Path | `optional-skills/creative/mono-color` |
| Version | `1.0.0` |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `design`, `poster`, `print`, `duotone`, `risograph`, `editorial`, `image-generation` |
| Related skills | [`baoyu-infographic`](/user-guide/skills/bundled/creative/creative-baoyu-infographic), [`meme-generation`](/user-guide/skills/optional/creative/creative-meme-generation), [`pixel-art`](/user-guide/skills/optional/creative/creative-pixel-art) |
...
- The Panergos `image_generate` tool (search/describe it via the deferred-tool catalog if not loaded). If image generation is unavailable, deliver prompt-only and say so.
