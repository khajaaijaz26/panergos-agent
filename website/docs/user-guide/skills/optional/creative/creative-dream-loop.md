...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/creative/dream-loop` |
| Path | `optional-skills/creative/dream-loop` |
| Version | `1.0.0` |
| License | MIT |
| Platforms | linux, macos |
| Tags | `3d`, `games`, `webgl`, `threejs`, `image-generation`, `visual-fidelity`, `creative` |
| Related skills | [`p5js`](/user-guide/skills/bundled/creative/creative-p5js), [`claude-design`](/user-guide/skills/bundled/creative/creative-claude-design), [`manim-video`](/user-guide/skills/bundled/creative/creative-manim-video) |
