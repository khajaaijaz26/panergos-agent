...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/web-development/page-agent` |
...
- User wants **Panergos itself to drive a browser** → use Panergos' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
