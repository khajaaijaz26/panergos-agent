...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/web-development/scrollcraft` |
| Path | `optional-skills/web-development/scrollcraft` |
| Version | `1.0.0` |
| Author | nateherkai (upstream scroll-craft), ported by Panergos Agent |
| License | MIT |
...
1. **Variety is the product.** At least four device families, never the same
   device twice in a row. Read [references/devices.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/devices.md).
2. **The world is photographic** unless the brand is genuinely illustrated.
   Clay/low-poly diorama is banned as a default. Read [references/worlds.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/worlds.md).
3. **No continuous chain** unless the brief is literally "one continuous
   journey" (then see [references/worldflight.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/worldflight.md)).
4. **A different world is not a different page.** Structure is a separate axis;
   decide it deliberately. Read [references/uniqueness.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/uniqueness.md).
...
4. **How should someone feel while scrolling, stage by stage, and what is the
   ...
   See [references/feel.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/feel.md).
...
6. **How far from premium-minimal?** Offer the range in
   [references/uniqueness.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/uniqueness.md) §5: brutalist,
...
[templates/FINGERPRINTS.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/templates/FINGERPRINTS.md), starts empty — the gate
...
direction from [references/worlds.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/worlds.md). Then write the
...
Full detail in [references/uniqueness.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/uniqueness.md).
...
- **Write the feeling curve before the score table** (method:
  [references/feel.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/feel.md)). Then assign each beat a device in
...
Full pipeline, prompt scaffolds and model notes: [references/assets.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/assets.md).

**Panergos-native paths first:**
...
[scripts/kie.mjs](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/scripts/kie.mjs)): photoreal stills and camera-move clips.
...
Start from [references/template.html](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/template.html). Device
patterns: [references/devices.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/devices.md). Spacing, type, depth,
colour: [references/taste.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/taste.md) — read it before writing
...
the two you looked at. Full procedure: [references/verify.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/verify.md).
...
anything. Run the feel check ([references/feel.md](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/feel.md) §6):
...
[references/device-diag.html](https://github.com/khajaaijaz26/panergos-agent/blob/main/optional-skills/web-development/scrollcraft/references/device-diag.html) beside the site on
...
- `scripts/shoot.mjs` needs Playwright (`npm install playwright` or
  `playwright-core` plus a Chrome install). Panergos' `browser_exec` tool is the
