...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/productivity/property-listings` |
...
Present researched properties as browsable cards in the Panergos desktop transcript.
...
- A Panergos desktop conversation for native cards; the backend may be local or remote.
...
```text
panergos skills install official/productivity/property-listings
```
