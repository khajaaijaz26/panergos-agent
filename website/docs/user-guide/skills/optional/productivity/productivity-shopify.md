...
| | |
|---|---|
| Source | Optional — install with `panergos skills install official/productivity/shopify` |
...
4. Save to `${PANERGOS_HOME:-~/.panergos}/.env`:
   ```
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Panergos","productType":"Apparel","tags":["test"]}}'
```
