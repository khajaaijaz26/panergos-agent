...
|-------|---------|------------|--------|
| **Panergos Teal** (`default`) | Dark teal + cream | System stack, 15px | 0.5rem radius, comfortable |
| **Panergos Teal (Large)** (`default-large`) | Same as default | System stack, 18px, line-height 1.65 | 0.5rem radius, spacious |
...
Themes that reference Google Fonts (all except Panergos Teal) load the stylesheet on demand — the first time you switch to them a `<link>` tag is injected into `<head>`.
