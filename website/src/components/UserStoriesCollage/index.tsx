...
> = {
  ...
  'business-ops': {
    label: 'Business Ops',
    solid: '#ff6b5e',
    soft: 'rgba(255, 107, 94, 0.14)',
    strip: 'linear-gradient(90deg, #c94c43, #ff6b5e, #f7c453)',
  },
  trading: {
    label: 'Trading & Markets',
    solid: '#f7c453',
    soft: 'rgba(247, 196, 83, 0.16)',
    strip: 'linear-gradient(90deg, #b47714, #f7c453, #ffda83)',
  },
  research: {
    label: 'Research',
    solid: '#a78bfa',
  ...
  'cost-optimization': {
    ...
    solid: '#2ee6a6',
    soft: 'rgba(46, 230, 166, 0.16)',
    strip: 'linear-gradient(90deg, #14755d, #2ee6a6, #9af5d7)',
  },
  meta: {
  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          Independently submitted Panergos stories will appear here after their
          source links have been reviewed.
        </p>
      ...
      {visible.length === 0 ? (
        <div className={styles.empty}>
          No independently verified Panergos stories have been published yet.
        </div>
      ) : (
      ...
      <div className={styles.footer}>
        Built something with Panergos?{' '}
        <a
          href="https://github.com/khajaaijaz26/panergos-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://github.com/khajaaijaz26/panergos-agent/discussions" target="_blank" rel="noopener noreferrer">
          Panergos discussions
        </a>{' '}
